...
extern "C" {
#endif
void CR_aB_X5__0___Overlap_X1__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp48 = inteval->PA_x[vi] * target[((hsi*12+0)*1+lsi)*1];
...
fp40 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+2)*1+lsi)*1], fp41);
target[((hsi*12+4)*1+lsi)*1] = fp40;
LIBINT2_REALTYPE fp32;
LIBINT2_REALTYPE fp29;
fp29 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+4)*1+lsi)*1], fp30);
...
fp18 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+6)*1+lsi)*1], fp19);
...
fp49 = inteval->PB_x[vi] * target[((hsi*12+0)*1+lsi)*1];
target[((hsi*12+1)*1+lsi)*1] = fp49;
LIBINT2_REALTYPE fp47;
LIBINT2_REALTYPE fp44;
fp44 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+1)*1+lsi)*1], fp45);
...
fp36 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+3)*1+lsi)*1], fp37);
LIBINT2_REALTYPE fp33;
fp33 = fp36 + fp34;
target[((hsi*12+5)*1+lsi)*1] = fp33;
LIBINT2_REALTYPE fp28;
LIBINT2_REALTYPE fp25;
fp25 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+5)*1+lsi)*1], fp26);
...
fp14 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+7)*1+lsi)*1], fp15);
...
fp3 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+9)*1+lsi)*1], fp4);
...
fp7 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+8)*1+lsi)*1], fp8);
