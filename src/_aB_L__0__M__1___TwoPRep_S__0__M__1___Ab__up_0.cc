...
extern "C" {
#endif
void _aB_L__0__M__1___TwoPRep_S__0__M__1___Ab__up_0(const Libint_t* inteval) {
...
_aB_L__0__M__1___TwoPRep_S__0__M__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
