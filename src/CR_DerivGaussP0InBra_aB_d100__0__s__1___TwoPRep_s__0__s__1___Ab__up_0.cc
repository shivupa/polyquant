...
extern "C" {
#endif
void CR_DerivGaussP0InBra_aB_d100__0__s__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
...
fp3 = inteval->two_alpha0_bra[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp6 = inteval->two_alpha0_bra[vi] * src0[((hsi*10+3)*1+lsi)*1];
