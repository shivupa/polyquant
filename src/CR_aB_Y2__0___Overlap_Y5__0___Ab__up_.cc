...
fp75 = inteval->PB_y[vi] * target[((hsi*18+1)*1+lsi)*1];
...
fp71 = inteval->PB_y[vi] * target[((hsi*18+2)*1+lsi)*1];
...
fp67 = inteval->PB_y[vi] * target[((hsi*18+3)*1+lsi)*1];
...
fp63 = inteval->PB_y[vi] * target[((hsi*18+4)*1+lsi)*1];
...
fp58 = inteval->PA_y[vi] * target[((hsi*18+1)*1+lsi)*1];
...
fp54 = inteval->PA_y[vi] * target[((hsi*18+2)*1+lsi)*1];
...
fp46 = inteval->PA_y[vi] * target[((hsi*18+4)*1+lsi)*1];
...
fp50 = inteval->PA_y[vi] * target[((hsi*18+3)*1+lsi)*1];
...
fp42 = inteval->PA_y[vi] * target[((hsi*18+5)*1+lsi)*1];
...
fp38 = inteval->PA_y[vi] * target[((hsi*18+6)*1+lsi)*1];
...
fp34 = inteval->PA_y[vi] * target[((hsi*18+7)*1+lsi)*1];
...
fp27 = inteval->PA_y[vi] * target[((hsi*18+8)*1+lsi)*1];
...
fp20 = inteval->PA_y[vi] * target[((hsi*18+9)*1+lsi)*1];
...
fp13 = inteval->PA_y[vi] * target[((hsi*18+10)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*18+11)*1+lsi)*1];
