...
extern "C" {
#endif
void CR_aB_Y2__0___Overlap_Y5__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp76 = inteval->PB_y[vi] * target[((hsi*18+0)*1+lsi)*1];
...
fp72 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*18+1)*1+lsi)*1], fp73);
...
fp68 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*18+2)*1+lsi)*1], fp69);
...
fp64 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*18+3)*1+lsi)*1], fp65);
...
fp60 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*18+4)*1+lsi)*1], fp61);
target[((hsi*18+5)*1+lsi)*1] = fp60;
LIBINT2_REALTYPE fp59;
fp59 = inteval->PA_y[vi] * target[((hsi*18+0)*1+lsi)*1];
...
fp55 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+1)*1+lsi)*1], fp56);
...
fp51 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+2)*1+lsi)*1], fp52);
...
fp43 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+4)*1+lsi)*1], fp44);
...
fp47 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+3)*1+lsi)*1], fp48);
...
fp39 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+5)*1+lsi)*1], fp40);
...
fp35 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+6)*1+lsi)*1], fp36);
...
fp31 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+7)*1+lsi)*1], fp32);
...
fp24 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+8)*1+lsi)*1], fp25);
...
fp17 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+9)*1+lsi)*1], fp18);
...
fp10 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+10)*1+lsi)*1], fp11);
...
fp3 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*18+11)*1+lsi)*1], fp4);
