...
extern "C" {
#endif
void _overlap_S_P_prereq(const Libint_t* inteval, LIBINT2_REALTYPE* parent_stack) {
...
fp9 = libint2::fma_plus(inteval->PB_z[vi], fp4, 0.0000000000000000e+00);
...
fp11 = libint2::fma_plus(inteval->PB_y[vi], fp6, 0.0000000000000000e+00);
...
fp14 = libint2::fma_plus(inteval->PB_x[vi], fp7, 0.0000000000000000e+00);
