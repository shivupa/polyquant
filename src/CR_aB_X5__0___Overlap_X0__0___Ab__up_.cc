...
fp14 = inteval->PA_x[vi] * target[((hsi*6+1)*1+lsi)*1];
LIBINT2_REALTYPE fp12;
fp12 = fp14 + fp13;
target[((hsi*6+2)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
fp11 = inteval->PA_x[vi] * target[((hsi*6+2)*1+lsi)*1];
...
fp7 = inteval->PA_x[vi] * target[((hsi*6+3)*1+lsi)*1];
...
fp3 = inteval->PA_x[vi] * target[((hsi*6+4)*1+lsi)*1];
