...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_2_c_0_c_1_Sb__l__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp33 = 0.0000000000000000e+00 + src1[((hsi*12+7)*1+lsi)*1];
...
fp29 = 0.0000000000000000e+00 + src1[((hsi*12+5)*1+lsi)*1];
