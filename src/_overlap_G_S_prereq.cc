...
fp27 = libint2::fma_plus(inteval->PA_y[vi], fp26, fp28);
...
fp39 = libint2::fma_plus(inteval->PA_x[vi], fp38, fp40);
...
fp19 = libint2::fma_plus(inteval->PA_z[vi], fp16, fp20);
...
fp30 = libint2::fma_plus(inteval->PA_y[vi], fp27, fp31);
...
fp42 = libint2::fma_plus(inteval->PA_x[vi], fp39, fp43);
...
fp22 = libint2::fma_plus(inteval->PA_z[vi], fp19, fp23);
...
fp33 = libint2::fma_plus(inteval->PA_y[vi], fp30, fp34);
...
fp46 = libint2::fma_plus(inteval->PA_x[vi], fp42, fp47);
