...
extern "C" {
#endif
void CR_aB_p__0___CartesianMultipole_sB_0_c_0_c_0_Sb__d__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp16 = 0.0000000000000000e+00 + src0[((hsi*6+3)*1+lsi)*1];
...
fp7 = 0.0000000000000000e+00 + src1[((hsi*6+5)*1+lsi)*1];
...
fp1 = 0.0000000000000000e+00 + src2[((hsi*6+5)*1+lsi)*1];
