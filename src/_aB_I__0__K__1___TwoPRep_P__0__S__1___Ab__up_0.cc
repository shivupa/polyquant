...
extern "C" {
#endif
void _aB_I__0__K__1___TwoPRep_P__0__S__1___Ab__up_0(const Libint_t* inteval) {
...
_aB_I__0__K__1___TwoPRep_P__0__S__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
