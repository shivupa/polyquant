...
extern "C" {
#endif
void HRRPart0bra0ket0d010p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp40 = src0[((hsi*10+4)*lowdim+lsi)*1] + fp41;
...
fp32 = src0[((hsi*10+6)*lowdim+lsi)*1] + fp33;
...
fp24 = src0[((hsi*10+2)*lowdim+lsi)*1] + fp25;
...
fp16 = src0[((hsi*10+9)*lowdim+lsi)*1] + fp17;
...
fp8 = src0[((hsi*10+7)*lowdim+lsi)*1] + fp9;
