...
fp1 = libint2::fma_plus(inteval->PA_z[vi], src0[((hsi*3+2)*1+lsi)*1], fp2);
...
fp7 = libint2::fma_plus(inteval->PA_z[vi], src0[((hsi*3+0)*1+lsi)*1], fp8);
target[((hsi*9+6)*1+lsi)*1] = fp7;
LIBINT2_REALTYPE fp11;
fp11 = inteval->WP_y[vi] * src1[((hsi*3+2)*1+lsi)*1];
LIBINT2_REALTYPE fp12;
LIBINT2_REALTYPE fp10;
fp10 = libint2::fma_plus(inteval->PA_y[vi], src0[((hsi*3+2)*1+lsi)*1], fp11);
...
fp20 = libint2::fma_plus(inteval->PA_x[vi], src0[((hsi*3+2)*1+lsi)*1], fp21);
target[((hsi*9+2)*1+lsi)*1] = fp20;
LIBINT2_REALTYPE fp24;
fp24 = inteval->WP_x[vi] * src1[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp25;
LIBINT2_REALTYPE fp23;
fp23 = libint2::fma_plus(inteval->PA_x[vi], src0[((hsi*3+1)*1+lsi)*1], fp24);
target[((hsi*9+1)*1+lsi)*1] = fp23;
LIBINT2_REALTYPE fp29;
fp29 = inteval->WP_x[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp30;
LIBINT2_REALTYPE fp28;
fp28 = libint2::fma_plus(inteval->PA_x[vi], src0[((hsi*3+0)*1+lsi)*1], fp29);
