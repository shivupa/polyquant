...
extern "C" {
#endif
void eri3_aB_P__0__K__1___TwoPRep_unit__0__F__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_P__0__K__1___TwoPRep_unit__0__F__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
{
const int vi = 0;
HRRPart1bra0ket0lp(inteval, &(inteval->stack[((hsi*405+1686)*1+lsi)*1]), &(inteval->stack[((hsi*165+198)*1+lsi)*1]), &(inteval->stack[((hsi*135+363)*1+lsi)*1]),3);
HRRPart1bra0ket0kp(inteval, &(inteval->stack[((hsi*324+2091)*1+lsi)*1]), &(inteval->stack[((hsi*135+363)*1+lsi)*1]), &(inteval->stack[((hsi*108+498)*1+lsi)*1]),3);
...
HRRPart1bra0ket0mp(inteval, &(inteval->stack[((hsi*495+3063)*1+lsi)*1]), &(inteval->stack[((hsi*198+0)*1+lsi)*1]), &(inteval->stack[((hsi*165+198)*1+lsi)*1]),3);
