...
fp85 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*6+1)*1+lsi)*1];
...
fp77 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*6+2)*1+lsi)*1];
...
fp66 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*6+3)*1+lsi)*1];
