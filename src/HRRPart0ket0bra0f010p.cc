...
extern "C" {
#endif
void HRRPart0ket0bra0f010p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp53 = 1.0000000000000000e+00 * src2[((hsi*10+1)*lowdim+lsi)*1];
...
fp49 = 1.0000000000000000e+00 * src2[((hsi*10+2)*lowdim+lsi)*1];
...
fp45 = 1.0000000000000000e+00 * src2[((hsi*10+3)*lowdim+lsi)*1];
...
fp29 = 1.0000000000000000e+00 * src2[((hsi*10+7)*lowdim+lsi)*1];
...
fp25 = 1.0000000000000000e+00 * src2[((hsi*10+8)*lowdim+lsi)*1];
...
fp21 = 1.0000000000000000e+00 * src2[((hsi*10+9)*lowdim+lsi)*1];
...
fp37 = 1.0000000000000000e+00 * src2[((hsi*10+5)*lowdim+lsi)*1];
