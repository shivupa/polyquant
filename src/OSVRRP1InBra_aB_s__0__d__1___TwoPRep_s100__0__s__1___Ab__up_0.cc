...
extern "C" {
#endif
void OSVRRP1InBra_aB_s__0__d__1___TwoPRep_s100__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp23 = inteval->roe[vi] * src3[((hsi*1+0)*1+lsi)*1];
...
fp26 = inteval->WQ_x[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp27;
fp27 = inteval->QC_x[vi] * src0[((hsi*3+0)*1+lsi)*1];
