...
fp92 = inteval->PB_x[vi] * target[((hsi*20+1)*1+lsi)*1];
...
fp88 = inteval->PB_x[vi] * target[((hsi*20+2)*1+lsi)*1];
...
fp79 = inteval->PA_x[vi] * target[((hsi*20+1)*1+lsi)*1];
...
fp75 = inteval->PA_x[vi] * target[((hsi*20+2)*1+lsi)*1];
...
fp71 = inteval->PA_x[vi] * target[((hsi*20+3)*1+lsi)*1];
...
fp84 = inteval->PB_x[vi] * target[((hsi*20+3)*1+lsi)*1];
...
fp67 = inteval->PA_x[vi] * target[((hsi*20+4)*1+lsi)*1];
...
fp59 = inteval->PA_x[vi] * target[((hsi*20+6)*1+lsi)*1];
...
fp52 = inteval->PA_x[vi] * target[((hsi*20+7)*1+lsi)*1];
...
fp45 = inteval->PA_x[vi] * target[((hsi*20+8)*1+lsi)*1];
...
fp63 = inteval->PA_x[vi] * target[((hsi*20+5)*1+lsi)*1];
...
fp38 = inteval->PA_x[vi] * target[((hsi*20+9)*1+lsi)*1];
...
fp31 = inteval->PA_x[vi] * target[((hsi*20+10)*1+lsi)*1];
...
fp27 = inteval->PA_x[vi] * target[((hsi*20+11)*1+lsi)*1];
...
fp20 = inteval->PA_x[vi] * target[((hsi*20+12)*1+lsi)*1];
...
fp6 = inteval->PA_x[vi] * target[((hsi*20+14)*1+lsi)*1];
