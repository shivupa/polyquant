...
extern "C" {
#endif
void _aB_K__0__K__1___TwoPRep_S__0__I__1___Ab__up_0(const Libint_t* inteval) {
...
_aB_K__0__K__1___TwoPRep_S__0__I__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
HRRPart1bra0ket0np(inteval, &(inteval->stack[((hsi*7128+73944)*1+lsi)*1]), &(inteval->stack[((hsi*2808+7056)*1+lsi)*1]), &(inteval->stack[((hsi*2376+9864)*1+lsi)*1]),36);
...
HRRPart1bra0ket0op(inteval, &(inteval->stack[((hsi*8424+109152)*1+lsi)*1]), &(inteval->stack[((hsi*3276+3780)*1+lsi)*1]), &(inteval->stack[((hsi*2808+7056)*1+lsi)*1]),36);
HRRPart1bra0ket0nd(inteval, &(inteval->stack[((hsi*14256+117576)*1+lsi)*1]), &(inteval->stack[((hsi*8424+109152)*1+lsi)*1]), &(inteval->stack[((hsi*7128+73944)*1+lsi)*1]),36);
...
HRRPart1bra0ket0qp(inteval, &(inteval->stack[((hsi*9828+53424)*1+lsi)*1]), &(inteval->stack[((hsi*3780+0)*1+lsi)*1]), &(inteval->stack[((hsi*3276+3780)*1+lsi)*1]),36);
HRRPart1bra0ket0od(inteval, &(inteval->stack[((hsi*16848+0)*1+lsi)*1]), &(inteval->stack[((hsi*9828+53424)*1+lsi)*1]), &(inteval->stack[((hsi*8424+109152)*1+lsi)*1]),36);
HRRPart1bra0ket0nf(inteval, &(inteval->stack[((hsi*23760+175932)*1+lsi)*1]), &(inteval->stack[((hsi*16848+0)*1+lsi)*1]), &(inteval->stack[((hsi*14256+117576)*1+lsi)*1]),36);
