...
fp32 = inteval->PA_y[vi] * target[((hsi*10+2)*1+lsi)*1];
...
fp21 = inteval->PA_y[vi] * target[((hsi*10+4)*1+lsi)*1];
...
fp36 = inteval->PA_y[vi] * target[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp33;
fp33 = fp36 + fp34;
target[((hsi*10+3)*1+lsi)*1] = fp33;
LIBINT2_REALTYPE fp28;
fp28 = inteval->PA_y[vi] * target[((hsi*10+3)*1+lsi)*1];
...
fp17 = inteval->PA_y[vi] * target[((hsi*10+5)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*10+7)*1+lsi)*1];
...
fp10 = inteval->PA_y[vi] * target[((hsi*10+6)*1+lsi)*1];
