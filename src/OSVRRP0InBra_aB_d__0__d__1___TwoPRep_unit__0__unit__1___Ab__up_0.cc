...
fp78 = inteval->roz[vi] * src2[((hsi*6+4)*1+lsi)*1];
LIBINT2_REALTYPE fp77;
fp77 = src1[((hsi*6+4)*1+lsi)*1] - fp78;
...
fp86 = inteval->roz[vi] * src2[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp85;
fp85 = src1[((hsi*6+3)*1+lsi)*1] - fp86;
...
fp79 = inteval->WP_x[vi] * src0[((hsi*18+4)*1+lsi)*1];
...
fp87 = inteval->WP_x[vi] * src0[((hsi*18+3)*1+lsi)*1];
