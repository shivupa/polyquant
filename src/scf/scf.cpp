...
void POLYQUANT_SCF::set_input(const POLYQUANT_INPUT &input_params) { this->input_params = input_params; }
void POLYQUANT_SCF::set_molecule(const POLYQUANT_MOLECULE &input_molecule) { this->input_molecule = input_molecule; }
void POLYQUANT_SCF::set_basis(const POLYQUANT_BASIS &input_basis) { this->input_basis = input_basis; }
void POLYQUANT_SCF::set_integral(const POLYQUANT_INTEGRAL &input_integral) { this->input_integral = input_integral; }
