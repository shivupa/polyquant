...
fp112 = inteval->PA_x[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp109 = inteval->PA_x[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp103 = inteval->PA_x[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp93 = inteval->PA_x[vi] * src0[((hsi*10+6)*1+lsi)*1];
...
fp90 = inteval->PA_x[vi] * src0[((hsi*10+7)*1+lsi)*1];
...
fp85 = inteval->PA_x[vi] * src0[((hsi*10+8)*1+lsi)*1];
