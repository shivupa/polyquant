...
fp60 = inteval->PB_z[vi] * target[((hsi*18+1)*1+lsi)*1];
...
fp56 = inteval->PB_z[vi] * target[((hsi*18+2)*1+lsi)*1];
...
fp52 = inteval->PB_z[vi] * target[((hsi*18+3)*1+lsi)*1];
...
fp48 = inteval->PB_z[vi] * target[((hsi*18+4)*1+lsi)*1];
...
fp44 = inteval->PB_z[vi] * target[((hsi*18+5)*1+lsi)*1];
...
fp40 = inteval->PB_z[vi] * target[((hsi*18+6)*1+lsi)*1];
...
fp36 = inteval->PB_z[vi] * target[((hsi*18+7)*1+lsi)*1];
...
fp31 = inteval->PA_z[vi] * target[((hsi*18+1)*1+lsi)*1];
...
fp27 = inteval->PA_z[vi] * target[((hsi*18+2)*1+lsi)*1];
...
fp23 = inteval->PA_z[vi] * target[((hsi*18+3)*1+lsi)*1];
...
fp19 = inteval->PA_z[vi] * target[((hsi*18+4)*1+lsi)*1];
...
fp15 = inteval->PA_z[vi] * target[((hsi*18+5)*1+lsi)*1];
...
fp11 = inteval->PA_z[vi] * target[((hsi*18+6)*1+lsi)*1];
...
fp7 = inteval->PA_z[vi] * target[((hsi*18+7)*1+lsi)*1];
...
fp3 = inteval->PA_z[vi] * target[((hsi*18+8)*1+lsi)*1];
