...
extern "C" {
#endif
void eri3_aB_S__0__I__1___TwoPRep_unit__0__I__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_S__0__I__1___TwoPRep_unit__0__I__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
HRRPart1bra0ket0np(inteval, &(inteval->stack[((hsi*198+2437)*1+lsi)*1]), &(inteval->stack[((hsi*78+91)*1+lsi)*1]), &(inteval->stack[((hsi*66+169)*1+lsi)*1]),1);
...
HRRPart1bra0ket0op(inteval, &(inteval->stack[((hsi*234+1183)*1+lsi)*1]), &(inteval->stack[((hsi*91+0)*1+lsi)*1]), &(inteval->stack[((hsi*78+91)*1+lsi)*1]),1);
HRRPart1bra0ket0nd(inteval, &(inteval->stack[((hsi*396+0)*1+lsi)*1]), &(inteval->stack[((hsi*234+1183)*1+lsi)*1]), &(inteval->stack[((hsi*198+2437)*1+lsi)*1]),1);
