...
extern "C" {
#endif
void CR_aB_Z1__0___Overlap_Z9__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp69 = inteval->PB_z[vi] * target[((hsi*20+0)*1+lsi)*1];
...
fp65 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+1)*1+lsi)*1], fp66);
...
fp61 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+2)*1+lsi)*1], fp62);
...
fp57 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+3)*1+lsi)*1], fp58);
...
fp53 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+4)*1+lsi)*1], fp54);
...
fp49 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+5)*1+lsi)*1], fp50);
...
fp45 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+6)*1+lsi)*1], fp46);
...
fp41 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+7)*1+lsi)*1], fp42);
...
fp37 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*20+8)*1+lsi)*1], fp38);
...
fp32 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+1)*1+lsi)*1], fp33);
...
fp28 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+2)*1+lsi)*1], fp29);
...
fp24 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+3)*1+lsi)*1], fp25);
...
fp20 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+4)*1+lsi)*1], fp21);
...
fp16 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+5)*1+lsi)*1], fp17);
...
fp12 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+6)*1+lsi)*1], fp13);
...
fp8 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+7)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+8)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*20+9)*1+lsi)*1], fp1);
target[((hsi*20+19)*1+lsi)*1] = fp0;
LIBINT2_REALTYPE fp36;
fp36 = inteval->PA_z[vi] * target[((hsi*20+0)*1+lsi)*1];
