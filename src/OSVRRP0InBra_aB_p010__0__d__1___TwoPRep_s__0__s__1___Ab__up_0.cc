...
extern "C" {
#endif
void OSVRRP0InBra_aB_p010__0__d__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp34 = inteval->alpha1_rho_over_zeta2[vi] * src4[((hsi*6+4)*1+lsi)*1];
