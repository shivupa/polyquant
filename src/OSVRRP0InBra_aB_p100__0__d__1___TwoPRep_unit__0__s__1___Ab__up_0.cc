...
extern "C" {
#endif
void OSVRRP0InBra_aB_p100__0__d__1___TwoPRep_unit__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp44 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*6+1)*1+lsi)*1];
...
fp40 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*6+2)*1+lsi)*1];
...
fp38 = fp41 - fp39;
target[((hsi*18+2)*1+lsi)*1] = fp38;
LIBINT2_REALTYPE fp33;
fp33 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp32;
fp32 = 1.0000000000000000e+00 * fp33;
LIBINT2_REALTYPE fp36;
fp36 = 1.0000000000000000e+00 * inteval->oo2ze[vi];
LIBINT2_REALTYPE fp35;
fp35 = fp36 * src1[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp37;
fp37 = inteval->WP_x[vi] * src0[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp34;
fp34 = fp37 + fp35;
LIBINT2_REALTYPE fp31;
fp31 = fp34 - fp32;
target[((hsi*18+3)*1+lsi)*1] = fp31;
LIBINT2_REALTYPE fp27;
fp27 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*6+4)*1+lsi)*1];
LIBINT2_REALTYPE fp26;
fp26 = 1.0000000000000000e+00 * fp27;
LIBINT2_REALTYPE fp29;
fp29 = fp36 * src1[((hsi*3+2)*1+lsi)*1];
LIBINT2_REALTYPE fp30;
fp30 = inteval->WP_x[vi] * src0[((hsi*6+4)*1+lsi)*1];
...
fp18 = fp51 * src1[((hsi*3+1)*1+lsi)*1];
...
fp14 = fp36 * src1[((hsi*3+0)*1+lsi)*1];
