...
extern "C" {
#endif
void HRRPart1bra0ket0gp100(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp66 = src0[((hsi*21+6)*1+lsi)*1] + fp67;
...
fp74 = src0[((hsi*21+5)*1+lsi)*1] + fp75;
...
fp82 = src0[((hsi*21+11)*1+lsi)*1] + fp83;
...
fp98 = src0[((hsi*21+8)*1+lsi)*1] + fp99;
...
fp106 = src0[((hsi*21+1)*1+lsi)*1] + fp107;
...
fp114 = src0[((hsi*21+3)*1+lsi)*1] + fp115;
...
fp10 = src0[((hsi*21+14)*1+lsi)*1] + fp11;
...
fp18 = src0[((hsi*21+18)*1+lsi)*1] + fp19;
...
fp58 = src0[((hsi*21+17)*1+lsi)*1] + fp59;
...
fp34 = src0[((hsi*21+19)*1+lsi)*1] + fp35;
...
fp42 = src0[((hsi*21+12)*1+lsi)*1] + fp43;
...
fp50 = src0[((hsi*21+16)*1+lsi)*1] + fp51;
...
fp26 = src0[((hsi*21+13)*1+lsi)*1] + fp27;
