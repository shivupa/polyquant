...
fp54 = inteval->PA_y[vi] * target[((hsi*14+2)*1+lsi)*1];
...
fp43 = inteval->PA_y[vi] * target[((hsi*14+4)*1+lsi)*1];
LIBINT2_REALTYPE fp40;
fp40 = fp43 + fp41;
target[((hsi*14+6)*1+lsi)*1] = fp40;
LIBINT2_REALTYPE fp32;
fp32 = inteval->PA_y[vi] * target[((hsi*14+6)*1+lsi)*1];
...
fp21 = inteval->PA_y[vi] * target[((hsi*14+8)*1+lsi)*1];
...
fp58 = inteval->PA_y[vi] * target[((hsi*14+1)*1+lsi)*1];
LIBINT2_REALTYPE fp55;
fp55 = fp58 + fp56;
target[((hsi*14+3)*1+lsi)*1] = fp55;
LIBINT2_REALTYPE fp50;
fp50 = inteval->PA_y[vi] * target[((hsi*14+3)*1+lsi)*1];
...
fp39 = inteval->PA_y[vi] * target[((hsi*14+5)*1+lsi)*1];
...
fp28 = inteval->PA_y[vi] * target[((hsi*14+7)*1+lsi)*1];
...
fp17 = inteval->PA_y[vi] * target[((hsi*14+9)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*14+11)*1+lsi)*1];
...
fp10 = inteval->PA_y[vi] * target[((hsi*14+10)*1+lsi)*1];
