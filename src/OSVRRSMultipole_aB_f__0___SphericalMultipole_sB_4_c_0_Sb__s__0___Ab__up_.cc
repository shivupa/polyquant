...
extern "C" {
#endif
void OSVRRSMultipole_aB_f__0___SphericalMultipole_sB_4_c_0_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp35 = inteval->PA_y[vi] * src0[((hsi*6+0)*1+lsi)*1];
...
fp41 = inteval->PA_z[vi] * src0[((hsi*6+2)*1+lsi)*1];
...
fp49 = inteval->PA_y[vi] * src0[((hsi*6+1)*1+lsi)*1];
