...
fp42 = libint2::fma_plus(inteval->AB_z[vi], src1[((hsi*6+0)*lowdim+lsi)*1], src0[((hsi*10+4)*lowdim+lsi)*1]);
...
fp34 = libint2::fma_plus(inteval->AB_z[vi], src1[((hsi*6+1)*lowdim+lsi)*1], src0[((hsi*10+6)*lowdim+lsi)*1]);
...
fp26 = libint2::fma_plus(inteval->AB_z[vi], src1[((hsi*6+2)*lowdim+lsi)*1], src0[((hsi*10+2)*lowdim+lsi)*1]);
...
fp18 = libint2::fma_plus(inteval->AB_z[vi], src1[((hsi*6+3)*lowdim+lsi)*1], src0[((hsi*10+9)*lowdim+lsi)*1]);
