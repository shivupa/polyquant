...
{
const int vi = 0;
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*675+7164)*1+lsi)*1]), &(inteval->stack[((hsi*315+1974)*1+lsi)*1]), &(inteval->stack[((hsi*225+2289)*1+lsi)*1]),15);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*450+7839)*1+lsi)*1]), &(inteval->stack[((hsi*225+2289)*1+lsi)*1]), &(inteval->stack[((hsi*150+2514)*1+lsi)*1]),15);
...
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*945+9189)*1+lsi)*1]), &(inteval->stack[((hsi*420+1554)*1+lsi)*1]), &(inteval->stack[((hsi*315+1974)*1+lsi)*1]),15);
...
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*945+7164)*1+lsi)*1]), &(inteval->stack[((hsi*441+588)*1+lsi)*1]), &(inteval->stack[((hsi*315+1029)*1+lsi)*1]),21);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*630+8109)*1+lsi)*1]), &(inteval->stack[((hsi*315+1029)*1+lsi)*1]), &(inteval->stack[((hsi*210+1344)*1+lsi)*1]),21);
...
HRRPart1bra0ket0gd(inteval, &(inteval->stack[((hsi*1890+12984)*1+lsi)*1]), &(inteval->stack[((hsi*1323+1029)*1+lsi)*1]), &(inteval->stack[((hsi*945+7164)*1+lsi)*1]),21);
