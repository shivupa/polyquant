...
extern "C" {
#endif
void eri3_aB_K__0__K__1___TwoPRep_unit__0__G__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_K__0__K__1___TwoPRep_unit__0__G__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
HRRPart1bra0ket0np(inteval, &(inteval->stack[((hsi*7128+50040)*1+lsi)*1]), &(inteval->stack[((hsi*2808+0)*1+lsi)*1]), &(inteval->stack[((hsi*2376+2808)*1+lsi)*1]),36);
