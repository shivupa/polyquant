...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_2_c__minus_1_Sb__f__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp12 = fp22 + src3[((hsi*6+4)*1+lsi)*1];
...
fp21 = -5.0000000000000000e-01 * src2[((hsi*6+3)*1+lsi)*1];
...
fp27 = 0.0000000000000000e+00 + src3[((hsi*6+0)*1+lsi)*1];
...
fp32 = -5.0000000000000000e-01 * src2[((hsi*6+0)*1+lsi)*1];
...
fp36 = fp37 + src3[((hsi*6+2)*1+lsi)*1];
...
fp43 = -5.0000000000000000e-01 * src2[((hsi*6+1)*1+lsi)*1];
