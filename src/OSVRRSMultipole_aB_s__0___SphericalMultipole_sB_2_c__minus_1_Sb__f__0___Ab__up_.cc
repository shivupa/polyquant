...
fp20 = libint2::fma_plus(-5.0000000000000000e-01, src2[((hsi*6+3)*1+lsi)*1], fp22);
...
fp31 = libint2::fma_plus(-5.0000000000000000e-01, src2[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
