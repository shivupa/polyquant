...
fp29 = -5.0000000000000000e-01 * src2[((hsi*10+3)*1+lsi)*1];
...
fp35 = fp36 + src3[((hsi*10+8)*1+lsi)*1];
...
fp41 = fp42 + src3[((hsi*10+7)*1+lsi)*1];
...
fp47 = 0.0000000000000000e+00 + src3[((hsi*10+1)*1+lsi)*1];
...
fp52 = -5.0000000000000000e-01 * src2[((hsi*10+5)*1+lsi)*1];
...
fp58 = 0.0000000000000000e+00 + src3[((hsi*10+0)*1+lsi)*1];
...
fp67 = fp68 + src3[((hsi*10+2)*1+lsi)*1];
...
fp74 = -5.0000000000000000e-01 * src2[((hsi*10+1)*1+lsi)*1];
