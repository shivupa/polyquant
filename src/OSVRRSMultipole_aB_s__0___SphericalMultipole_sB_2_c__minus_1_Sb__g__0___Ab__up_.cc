...
fp8 = 0.0000000000000000e+00 + src3[((hsi*10+5)*1+lsi)*1];
...
fp12 = 0.0000000000000000e+00 + src3[((hsi*10+3)*1+lsi)*1];
...
fp16 = fp17 + src3[((hsi*10+6)*1+lsi)*1];
...
fp22 = fp28 + src3[((hsi*10+4)*1+lsi)*1];
...
fp26 = libint2::fma_plus(-5.0000000000000000e-01, src2[((hsi*10+3)*1+lsi)*1], fp28);
...
fp33 = fp34 + src3[((hsi*10+8)*1+lsi)*1];
...
fp39 = fp40 + src3[((hsi*10+7)*1+lsi)*1];
...
fp45 = 0.0000000000000000e+00 + src3[((hsi*10+1)*1+lsi)*1];
...
fp50 = -5.0000000000000000e-01 * src2[((hsi*10+5)*1+lsi)*1];
...
fp56 = 0.0000000000000000e+00 + src3[((hsi*10+0)*1+lsi)*1];
...
fp60 = libint2::fma_plus(-5.0000000000000000e-01, src2[((hsi*10+0)*1+lsi)*1], 0.0000000000000000e+00);
...
fp65 = fp66 + src3[((hsi*10+2)*1+lsi)*1];
...
fp72 = -5.0000000000000000e-01 * src2[((hsi*10+1)*1+lsi)*1];
...
fp78 = libint2::fma_plus(3.0000000000000000e+00, src1[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
