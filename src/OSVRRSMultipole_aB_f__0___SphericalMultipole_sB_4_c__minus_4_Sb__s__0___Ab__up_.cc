...
extern "C" {
#endif
void OSVRRSMultipole_aB_f__0___SphericalMultipole_sB_4_c__minus_4_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp13 = -5.0000000000000000e-01 * src3[((hsi*6+3)*1+lsi)*1];
...
fp21 = -5.0000000000000000e-01 * src3[((hsi*6+0)*1+lsi)*1];
