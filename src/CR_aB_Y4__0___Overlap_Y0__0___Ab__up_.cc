...
fp8 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*5+1)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*5+2)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*5+3)*1+lsi)*1], fp1);
