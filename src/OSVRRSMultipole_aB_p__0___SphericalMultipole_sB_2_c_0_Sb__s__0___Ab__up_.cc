...
extern "C" {
#endif
void OSVRRSMultipole_aB_p__0___SphericalMultipole_sB_2_c_0_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp10 = libint2::fma_plus(inteval->PA_x[vi], src0[((hsi*1+0)*1+lsi)*1], fp11);
