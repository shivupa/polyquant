...
extern "C" {
#endif
void eri3_aB_H__0__L__1___TwoPRep_unit__0__P__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_H__0__L__1___TwoPRep_unit__0__P__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
const int lsi = 0;
const int vi = 0;
inteval->targets[0] = &(inteval->stack[((hsi*2835+2100)*1+lsi)*1]);
/** Number of flops = 0 */
}
