...
extern "C" {
#endif
void CR_aB_f__0___CartesianMultipole_sB_0_c_0_c_0_Sb__p__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp4 = 0.0000000000000000e+00 + src2[((hsi*8+7)*1+lsi)*1];
