...
extern "C" {
#endif
void OSVRRP1InBra_aB_f010__0__p__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp70 = fp78 * src2[((hsi*10+1)*1+lsi)*1];
...
fp65 = fp78 * src2[((hsi*10+2)*1+lsi)*1];
...
fp52 = fp78 * src2[((hsi*10+3)*1+lsi)*1];
...
fp45 = fp78 * src2[((hsi*10+4)*1+lsi)*1];
...
fp36 = fp78 * src2[((hsi*10+5)*1+lsi)*1];
...
fp29 = fp78 * src2[((hsi*10+6)*1+lsi)*1];
...
fp21 = fp78 * src2[((hsi*10+7)*1+lsi)*1];
...
fp14 = fp78 * src2[((hsi*10+8)*1+lsi)*1];
