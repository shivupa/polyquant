...
extern "C" {
#endif
void CR_aB_X2__0___Overlap_X3__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp30 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*12+1)*1+lsi)*1], fp31);
...
fp21 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+2)*1+lsi)*1], fp27);
target[((hsi*12+6)*1+lsi)*1] = fp21;
LIBINT2_REALTYPE fp24;
LIBINT2_REALTYPE fp23;
fp23 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+1)*1+lsi)*1], fp31);
...
fp26 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*12+2)*1+lsi)*1], fp27);
...
fp17 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+3)*1+lsi)*1], fp18);
...
fp2 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+7)*1+lsi)*1], fp3);
...
fp7 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+6)*1+lsi)*1], fp8);
...
fp12 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+5)*1+lsi)*1], fp13);
LIBINT2_REALTYPE fp10;
fp10 = fp12 + fp11;
target[((hsi*12+9)*1+lsi)*1] = fp10;
LIBINT2_REALTYPE fp16;
LIBINT2_REALTYPE fp15;
fp15 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*12+4)*1+lsi)*1], fp31);
