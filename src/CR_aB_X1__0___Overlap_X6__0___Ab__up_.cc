...
extern "C" {
#endif
void CR_aB_X1__0___Overlap_X6__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp41 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*14+1)*1+lsi)*1], fp42);
...
fp37 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*14+2)*1+lsi)*1], fp38);
target[((hsi*14+3)*1+lsi)*1] = fp37;
LIBINT2_REALTYPE fp36;
LIBINT2_REALTYPE fp33;
fp33 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*14+3)*1+lsi)*1], fp34);
...
fp29 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*14+4)*1+lsi)*1], fp30);
...
fp25 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*14+5)*1+lsi)*1], fp26);
...
fp0 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+6)*1+lsi)*1], fp1);
...
fp4 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+5)*1+lsi)*1], fp5);
...
fp8 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+4)*1+lsi)*1], fp9);
...
fp12 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+3)*1+lsi)*1], fp13);
...
fp16 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+2)*1+lsi)*1], fp17);
...
fp20 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*14+1)*1+lsi)*1], fp21);
