...
fp95 = inteval->alpha1_rho_over_zeta2[vi] * src4[((hsi*10+3)*1+lsi)*1];
...
fp87 = inteval->alpha1_rho_over_zeta2[vi] * src4[((hsi*10+4)*1+lsi)*1];
...
fp60 = inteval->alpha1_rho_over_zeta2[vi] * src4[((hsi*10+7)*1+lsi)*1];
...
fp51 = inteval->alpha1_rho_over_zeta2[vi] * src4[((hsi*10+8)*1+lsi)*1];
