...
fp43 = inteval->PA_y[vi] * target[((hsi*12+2)*1+lsi)*1];
LIBINT2_REALTYPE fp40;
fp40 = fp43 + fp41;
target[((hsi*12+4)*1+lsi)*1] = fp40;
LIBINT2_REALTYPE fp32;
fp32 = inteval->PA_y[vi] * target[((hsi*12+4)*1+lsi)*1];
...
fp21 = inteval->PA_y[vi] * target[((hsi*12+6)*1+lsi)*1];
...
fp47 = inteval->PA_y[vi] * target[((hsi*12+1)*1+lsi)*1];
...
fp39 = inteval->PA_y[vi] * target[((hsi*12+3)*1+lsi)*1];
...
fp28 = inteval->PA_y[vi] * target[((hsi*12+5)*1+lsi)*1];
...
fp17 = inteval->PA_y[vi] * target[((hsi*12+7)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*12+9)*1+lsi)*1];
...
fp10 = inteval->PA_y[vi] * target[((hsi*12+8)*1+lsi)*1];
