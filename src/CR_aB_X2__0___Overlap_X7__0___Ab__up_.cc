...
fp105 = inteval->PB_x[vi] * target[((hsi*24+1)*1+lsi)*1];
...
fp101 = inteval->PB_x[vi] * target[((hsi*24+2)*1+lsi)*1];
...
fp97 = inteval->PB_x[vi] * target[((hsi*24+3)*1+lsi)*1];
...
fp93 = inteval->PB_x[vi] * target[((hsi*24+4)*1+lsi)*1];
...
fp89 = inteval->PB_x[vi] * target[((hsi*24+5)*1+lsi)*1];
...
fp85 = inteval->PB_x[vi] * target[((hsi*24+6)*1+lsi)*1];
...
fp80 = inteval->PA_x[vi] * target[((hsi*24+1)*1+lsi)*1];
...
fp76 = inteval->PA_x[vi] * target[((hsi*24+2)*1+lsi)*1];
...
fp72 = inteval->PA_x[vi] * target[((hsi*24+3)*1+lsi)*1];
...
fp64 = inteval->PA_x[vi] * target[((hsi*24+5)*1+lsi)*1];
...
fp60 = inteval->PA_x[vi] * target[((hsi*24+6)*1+lsi)*1];
...
fp68 = inteval->PA_x[vi] * target[((hsi*24+4)*1+lsi)*1];
...
fp56 = inteval->PA_x[vi] * target[((hsi*24+7)*1+lsi)*1];
...
fp52 = inteval->PA_x[vi] * target[((hsi*24+8)*1+lsi)*1];
...
fp48 = inteval->PA_x[vi] * target[((hsi*24+9)*1+lsi)*1];
...
fp41 = inteval->PA_x[vi] * target[((hsi*24+10)*1+lsi)*1];
...
fp34 = inteval->PA_x[vi] * target[((hsi*24+11)*1+lsi)*1];
...
fp27 = inteval->PA_x[vi] * target[((hsi*24+12)*1+lsi)*1];
...
fp20 = inteval->PA_x[vi] * target[((hsi*24+13)*1+lsi)*1];
...
fp13 = inteval->PA_x[vi] * target[((hsi*24+14)*1+lsi)*1];
...
fp6 = inteval->PA_x[vi] * target[((hsi*24+15)*1+lsi)*1];
