...
fp61 = inteval->PB_x[vi] * target[((hsi*15+0)*1+lsi)*1];
target[((hsi*15+1)*1+lsi)*1] = fp61;
LIBINT2_REALTYPE fp60;
fp60 = inteval->PB_x[vi] * target[((hsi*15+1)*1+lsi)*1];
...
fp56 = inteval->PB_x[vi] * target[((hsi*15+2)*1+lsi)*1];
...
fp39 = inteval->PA_x[vi] * target[((hsi*15+3)*1+lsi)*1];
...
fp43 = inteval->PA_x[vi] * target[((hsi*15+2)*1+lsi)*1];
...
fp47 = inteval->PA_x[vi] * target[((hsi*15+1)*1+lsi)*1];
LIBINT2_REALTYPE fp44;
fp44 = fp47 + fp45;
target[((hsi*15+6)*1+lsi)*1] = fp44;
LIBINT2_REALTYPE fp48;
fp48 = inteval->PA_x[vi] * target[((hsi*15+0)*1+lsi)*1];
...
fp52 = inteval->PB_x[vi] * target[((hsi*15+3)*1+lsi)*1];
...
fp35 = inteval->PA_x[vi] * target[((hsi*15+4)*1+lsi)*1];
...
fp6 = inteval->PA_x[vi] * target[((hsi*15+9)*1+lsi)*1];
...
fp13 = inteval->PA_x[vi] * target[((hsi*15+8)*1+lsi)*1];
...
fp20 = inteval->PA_x[vi] * target[((hsi*15+7)*1+lsi)*1];
...
fp27 = inteval->PA_x[vi] * target[((hsi*15+6)*1+lsi)*1];
...
fp31 = inteval->PA_x[vi] * target[((hsi*15+5)*1+lsi)*1];
