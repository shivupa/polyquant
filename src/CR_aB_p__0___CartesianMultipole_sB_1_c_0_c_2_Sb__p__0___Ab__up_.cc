...
fp33 = libint2::fma_plus(inteval->BO_x[vi], fp32, fp36);
...
fp19 = 0.0000000000000000e+00 + src2[((hsi*10+2)*1+lsi)*1];
...
fp21 = 0.0000000000000000e+00 + src2[((hsi*10+0)*1+lsi)*1];
...
fp40 = libint2::fma_plus(inteval->BO_x[vi], fp39, fp43);
