...
extern "C" {
#endif
void CR_aB_p__0___CartesianMultipole_sB_1_c_0_c_2_Sb__p__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp35 = 0.0000000000000000e+00 + src0[((hsi*10+1)*1+lsi)*1];
...
fp36 = 0.0000000000000000e+00 + src0[((hsi*10+2)*1+lsi)*1];
...
fp42 = 0.0000000000000000e+00 + src0[((hsi*10+6)*1+lsi)*1];
