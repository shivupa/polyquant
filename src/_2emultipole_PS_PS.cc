...
extern "C" {
#endif
void _2emultipole_PS_PS(const Libint_t* inteval) {

_libint2_static_api_bzero_short_(inteval->stack+0*1,43560)
const int contrdepth = inteval->contrdepth;
#ifdef __INTEL_COMPILER
#pragma ivdep
#endif
for(int c = 0; c<contrdepth; c++) {
_2emultipole_PS_PS_prereq(inteval+c, inteval->stack);
}
