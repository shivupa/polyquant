...
fp90 = inteval->PB_z[vi] * target[((hsi*21+1)*1+lsi)*1];
...
fp86 = inteval->PB_z[vi] * target[((hsi*21+2)*1+lsi)*1];
...
fp82 = inteval->PB_z[vi] * target[((hsi*21+3)*1+lsi)*1];
...
fp78 = inteval->PB_z[vi] * target[((hsi*21+4)*1+lsi)*1];
...
fp74 = inteval->PB_z[vi] * target[((hsi*21+5)*1+lsi)*1];
...
fp69 = inteval->PA_z[vi] * target[((hsi*21+1)*1+lsi)*1];
...
fp65 = inteval->PA_z[vi] * target[((hsi*21+2)*1+lsi)*1];
...
fp57 = inteval->PA_z[vi] * target[((hsi*21+4)*1+lsi)*1];
...
fp53 = inteval->PA_z[vi] * target[((hsi*21+5)*1+lsi)*1];
...
fp61 = inteval->PA_z[vi] * target[((hsi*21+3)*1+lsi)*1];
...
fp49 = inteval->PA_z[vi] * target[((hsi*21+6)*1+lsi)*1];
...
fp45 = inteval->PA_z[vi] * target[((hsi*21+7)*1+lsi)*1];
...
fp41 = inteval->PA_z[vi] * target[((hsi*21+8)*1+lsi)*1];
...
fp34 = inteval->PA_z[vi] * target[((hsi*21+9)*1+lsi)*1];
...
fp27 = inteval->PA_z[vi] * target[((hsi*21+10)*1+lsi)*1];
...
fp20 = inteval->PA_z[vi] * target[((hsi*21+11)*1+lsi)*1];
...
fp13 = inteval->PA_z[vi] * target[((hsi*21+12)*1+lsi)*1];
...
fp6 = inteval->PA_z[vi] * target[((hsi*21+13)*1+lsi)*1];
