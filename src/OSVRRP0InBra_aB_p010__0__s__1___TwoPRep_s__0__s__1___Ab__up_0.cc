...
extern "C" {
#endif
void OSVRRP0InBra_aB_p010__0__s__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp5 = inteval->alpha1_rho_over_zeta2[vi] * src3[((hsi*1+0)*1+lsi)*1];
