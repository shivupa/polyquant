...
extern "C" {
#endif
void OSVRRP0InBra_aB_i__0__s__1___TwoPRep_unit__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp133 = inteval->roz[vi] * src2[((hsi*15+0)*1+lsi)*1];
...
fp135 = inteval->WP_x[vi] * src0[((hsi*21+0)*1+lsi)*1];
