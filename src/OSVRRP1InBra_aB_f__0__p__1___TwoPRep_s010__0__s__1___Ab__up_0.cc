...
extern "C" {
#endif
void OSVRRP1InBra_aB_f__0__p__1___TwoPRep_s010__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp134 = 1.0000000000000000e+00 * inteval->alpha2_over_zetapluseta[vi];
...
fp120 = fp134 * src3[((hsi*10+1)*1+lsi)*1];
...
fp109 = fp134 * src3[((hsi*10+2)*1+lsi)*1];
...
fp90 = fp134 * src3[((hsi*10+3)*1+lsi)*1];
...
fp77 = fp134 * src3[((hsi*10+4)*1+lsi)*1];
...
fp62 = fp134 * src3[((hsi*10+5)*1+lsi)*1];
...
fp49 = fp134 * src3[((hsi*10+6)*1+lsi)*1];
...
fp35 = fp134 * src3[((hsi*10+7)*1+lsi)*1];
...
fp22 = fp134 * src3[((hsi*10+8)*1+lsi)*1];
