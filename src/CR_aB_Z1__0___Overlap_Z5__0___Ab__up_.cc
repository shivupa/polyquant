...
fp33 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*12+1)*1+lsi)*1], fp34);
target[((hsi*12+2)*1+lsi)*1] = fp33;
LIBINT2_REALTYPE fp32;
LIBINT2_REALTYPE fp29;
fp29 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*12+2)*1+lsi)*1], fp30);
...
fp25 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*12+3)*1+lsi)*1], fp26);
...
fp21 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*12+4)*1+lsi)*1], fp22);
...
fp0 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*12+5)*1+lsi)*1], fp1);
...
fp4 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*12+4)*1+lsi)*1], fp5);
...
fp8 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*12+3)*1+lsi)*1], fp9);
...
fp12 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*12+2)*1+lsi)*1], fp13);
...
fp16 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*12+1)*1+lsi)*1], fp17);
