...
extern "C" {
#endif
void HRRPart1bra0ket0p010p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp3 = 1.0000000000000000e+00 * src2[((hsi*3+2)*1+lsi)*1];
...
fp11 = 1.0000000000000000e+00 * src2[((hsi*3+1)*1+lsi)*1];
...
fp19 = 1.0000000000000000e+00 * src2[((hsi*3+0)*1+lsi)*1];
