...
extern "C" {
#endif
void CR_aB_X4__0___Overlap_X0__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp8 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*5+1)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*5+2)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*5+3)*1+lsi)*1], fp1);
