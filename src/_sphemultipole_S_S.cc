...
extern "C" {
#endif
void _sphemultipole_S_S(const Libint_t* inteval) {
...
_sphemultipole_S_S_prereq(inteval+c, inteval->stack);
}
...
inteval->targets[20] = &(inteval->stack[((hsi*1+20)*1+lsi)*1]);
inteval->targets[21] = &(inteval->stack[((hsi*1+21)*1+lsi)*1]);
inteval->targets[22] = &(inteval->stack[((hsi*1+22)*1+lsi)*1]);
inteval->targets[23] = &(inteval->stack[((hsi*1+23)*1+lsi)*1]);
inteval->targets[24] = &(inteval->stack[((hsi*1+24)*1+lsi)*1]);
/** Number of flops = 0 */
}
