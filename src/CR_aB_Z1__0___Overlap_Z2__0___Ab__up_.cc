...
extern "C" {
#endif
void CR_aB_Z1__0___Overlap_Z2__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp7 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*6+1)*1+lsi)*1], fp8);
...
fp0 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*6+2)*1+lsi)*1], fp1);
target[((hsi*6+5)*1+lsi)*1] = fp0;
LIBINT2_REALTYPE fp5;
LIBINT2_REALTYPE fp4;
fp4 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*6+1)*1+lsi)*1], fp8);
