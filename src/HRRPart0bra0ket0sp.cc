...
fp0 = libint2::fma_plus(inteval->AB_z[vi], src1[((hsi*1+0)*1+lsi)*1], src0[((hsi*3+2)*lowdim+lsi)*1]);
target[((hsi*3+2)*lowdim+lsi)*1] = fp0;
LIBINT2_REALTYPE fp3;
LIBINT2_REALTYPE fp2;
fp2 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*1+0)*1+lsi)*1], src0[((hsi*3+1)*lowdim+lsi)*1]);
target[((hsi*3+1)*lowdim+lsi)*1] = fp2;
LIBINT2_REALTYPE fp5;
LIBINT2_REALTYPE fp4;
fp4 = libint2::fma_plus(inteval->AB_x[vi], src1[((hsi*1+0)*1+lsi)*1], src0[((hsi*3+0)*lowdim+lsi)*1]);
