...
extern "C" {
#endif
void deriv1eri2_aB_S__0__P__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval) {
...
deriv1eri2_aB_S__0__P__1___TwoPRep_unit__0__unit__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
