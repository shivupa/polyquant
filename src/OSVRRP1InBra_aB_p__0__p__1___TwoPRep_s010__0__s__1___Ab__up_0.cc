...
extern "C" {
#endif
void OSVRRP1InBra_aB_p__0__p__1___TwoPRep_s010__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp16 = fp29 * src3[((hsi*3+1)*1+lsi)*1];
...
fp28 = fp29 * src3[((hsi*3+0)*1+lsi)*1];
