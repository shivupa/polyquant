...
extern "C" {
#endif
void eri3_aB_H__0__K__1___TwoPRep_unit__0__G__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_H__0__K__1___TwoPRep_unit__0__G__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
{
const int vi = 0;
HRRPart1bra0ket0lp(inteval, &(inteval->stack[((hsi*2835+17220)*1+lsi)*1]), &(inteval->stack[((hsi*1155+3024)*1+lsi)*1]), &(inteval->stack[((hsi*945+4179)*1+lsi)*1]),21);
HRRPart1bra0ket0mp(inteval, &(inteval->stack[((hsi*3465+20055)*1+lsi)*1]), &(inteval->stack[((hsi*1386+1638)*1+lsi)*1]), &(inteval->stack[((hsi*1155+3024)*1+lsi)*1]),21);
...
HRRPart1bra0ket0kp(inteval, &(inteval->stack[((hsi*2268+29190)*1+lsi)*1]), &(inteval->stack[((hsi*945+4179)*1+lsi)*1]), &(inteval->stack[((hsi*756+5124)*1+lsi)*1]),21);
...
HRRPart1bra0ket0psp(inteval, &(inteval->stack[((hsi*4158+29190)*1+lsi)*1]), &(inteval->stack[((hsi*1638+0)*1+lsi)*1]), &(inteval->stack[((hsi*1386+1638)*1+lsi)*1]),21);
