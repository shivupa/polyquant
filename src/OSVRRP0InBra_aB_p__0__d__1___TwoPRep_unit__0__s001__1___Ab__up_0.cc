...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__d__1___TwoPRep_unit__0__s001__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp36 = fp40 * src1[((hsi*3+2)*1+lsi)*1];
...
fp31 = fp46 * src1[((hsi*3+1)*1+lsi)*1];
...
fp24 = inteval->WP_y[vi] * src0[((hsi*6+5)*1+lsi)*1];
...
fp12 = fp21 * src2[((hsi*6+2)*1+lsi)*1];
LIBINT2_REALTYPE fp14;
fp14 = fp46 * src1[((hsi*3+2)*1+lsi)*1];
...
fp5 = fp21 * src2[((hsi*6+4)*1+lsi)*1];
LIBINT2_REALTYPE fp27;
fp27 = fp40 * src1[((hsi*3+0)*1+lsi)*1];
