...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_4_c_1_Sb__g__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5) {
...
fp22 = fp28 + src5[((hsi*10+4)*1+lsi)*1];
...
fp26 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*10+3)*1+lsi)*1], fp28);
...
fp33 = fp34 + src5[((hsi*10+8)*1+lsi)*1];
LIBINT2_REALTYPE fp32;
fp32 = inteval->oo2z[vi] * fp33;
LIBINT2_REALTYPE fp36;
LIBINT2_REALTYPE fp31;
fp31 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*10+8)*1+lsi)*1], fp32);
...
fp39 = fp40 + src5[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp38;
fp38 = inteval->oo2z[vi] * fp39;
LIBINT2_REALTYPE fp42;
LIBINT2_REALTYPE fp37;
fp37 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*10+7)*1+lsi)*1], fp38);
target[((hsi*15+7)*1+lsi)*1] = fp37;
LIBINT2_REALTYPE fp45;
fp45 = 0.0000000000000000e+00 + src5[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp44;
fp44 = inteval->oo2z[vi] * fp45;
LIBINT2_REALTYPE fp46;
LIBINT2_REALTYPE fp43;
fp43 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*10+1)*1+lsi)*1], fp44);
target[((hsi*15+6)*1+lsi)*1] = fp43;
LIBINT2_REALTYPE fp50;
fp50 = 5.0000000000000000e-01 * src4[((hsi*10+5)*1+lsi)*1];
...
fp47 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*10+5)*1+lsi)*1], fp48);
target[((hsi*15+5)*1+lsi)*1] = fp47;
LIBINT2_REALTYPE fp56;
fp56 = 0.0000000000000000e+00 + src5[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp55;
fp55 = inteval->oo2z[vi] * fp56;
LIBINT2_REALTYPE fp57;
LIBINT2_REALTYPE fp54;
fp54 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*10+0)*1+lsi)*1], fp55);
target[((hsi*15+4)*1+lsi)*1] = fp54;
LIBINT2_REALTYPE fp61;
LIBINT2_REALTYPE fp60;
fp60 = libint2::fma_plus(5.0000000000000000e-01, src4[((hsi*10+0)*1+lsi)*1], 0.0000000000000000e+00);
LIBINT2_REALTYPE fp59;
fp59 = inteval->oo2z[vi] * fp60;
LIBINT2_REALTYPE fp62;
LIBINT2_REALTYPE fp58;
fp58 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*10+0)*1+lsi)*1], fp59);
...
fp65 = fp66 + src5[((hsi*10+2)*1+lsi)*1];
LIBINT2_REALTYPE fp64;
fp64 = inteval->oo2z[vi] * fp65;
LIBINT2_REALTYPE fp68;
LIBINT2_REALTYPE fp63;
fp63 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*10+2)*1+lsi)*1], fp64);
target[((hsi*15+2)*1+lsi)*1] = fp63;
LIBINT2_REALTYPE fp72;
fp72 = 5.0000000000000000e-01 * src4[((hsi*10+1)*1+lsi)*1];
...
fp69 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*10+1)*1+lsi)*1], fp70);
target[((hsi*15+1)*1+lsi)*1] = fp69;
LIBINT2_REALTYPE fp79;
fp79 = 5.0000000000000000e-01 * src3[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp81;
fp81 = 5.0000000000000000e-01 * src2[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp83;
LIBINT2_REALTYPE fp82;
fp82 = libint2::fma_plus(3.0000000000000000e+00, src1[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
...
fp76 = libint2::fma_plus(inteval->PB_x[vi], src0[((hsi*10+0)*1+lsi)*1], fp77);
