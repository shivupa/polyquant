...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__f__1___TwoPRep_s001__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp65 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+2)*1+lsi)*1];
...
fp57 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+3)*1+lsi)*1];
...
fp40 = inteval->alpha2_rho_over_zeta2[vi] * src4[((hsi*10+5)*1+lsi)*1];
