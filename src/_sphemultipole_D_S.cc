...
extern "C" {
#endif
void _sphemultipole_D_S(const Libint_t* inteval) {
...
_sphemultipole_D_S_prereq(inteval+c, inteval->stack);
}
...
inteval->targets[21] = &(inteval->stack[((hsi*6+126)*1+lsi)*1]);
inteval->targets[22] = &(inteval->stack[((hsi*6+132)*1+lsi)*1]);
inteval->targets[23] = &(inteval->stack[((hsi*6+138)*1+lsi)*1]);
inteval->targets[24] = &(inteval->stack[((hsi*6+144)*1+lsi)*1]);
/** Number of flops = 0 */
}
