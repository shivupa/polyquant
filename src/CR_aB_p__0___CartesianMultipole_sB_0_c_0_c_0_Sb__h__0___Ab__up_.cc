...
extern "C" {
#endif
void CR_aB_p__0___CartesianMultipole_sB_0_c_0_c_0_Sb__h__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp9 = 0.0000000000000000e+00 + src2[((hsi*12+1)*1+lsi)*1];
LIBINT2_REALTYPE fp14;
fp14 = 0.0000000000000000e+00 + src1[((hsi*12+10)*1+lsi)*1];
...
fp16 = 0.0000000000000000e+00 + src1[((hsi*12+11)*1+lsi)*1];
...
fp32 = 0.0000000000000000e+00 + src0[((hsi*12+7)*1+lsi)*1];
...
fp4 = 0.0000000000000000e+00 + src2[((hsi*12+11)*1+lsi)*1];
