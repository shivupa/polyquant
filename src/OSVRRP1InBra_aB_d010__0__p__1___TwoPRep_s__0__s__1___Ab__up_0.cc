...
extern "C" {
#endif
void OSVRRP1InBra_aB_d010__0__p__1___TwoPRep_s__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp60 = fp74 * src3[((hsi*6+1)*1+lsi)*1];
...
fp49 = fp74 * src3[((hsi*6+2)*1+lsi)*1];
...
fp31 = fp74 * src3[((hsi*6+3)*1+lsi)*1];
