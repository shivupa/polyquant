...
extern "C" {
#endif
void _aB_PS__0__K__1___TwoPRep_S__0__K__1___Ab__up_0(const Libint_t* inteval) {
...
_aB_PS__0__K__1___TwoPRep_S__0__K__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
