...
extern "C" {
#endif
void OSVRRP0InBra_aB_p001__0__d__1___TwoPRep_unit__0__s__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp36 = fp51 * src1[((hsi*3+1)*1+lsi)*1];
...
fp29 = inteval->WP_y[vi] * src0[((hsi*6+5)*1+lsi)*1];
...
fp18 = fp51 * src1[((hsi*3+2)*1+lsi)*1];
...
fp32 = fp45 * src1[((hsi*3+0)*1+lsi)*1];
