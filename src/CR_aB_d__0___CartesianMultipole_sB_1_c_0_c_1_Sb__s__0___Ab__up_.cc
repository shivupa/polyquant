...
extern "C" {
#endif
void CR_aB_d__0___CartesianMultipole_sB_1_c_0_c_1_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp9 = 0.0000000000000000e+00 + src2[((hsi*9+0)*1+lsi)*1];
...
fp13 = 0.0000000000000000e+00 + src1[((hsi*9+6)*1+lsi)*1];
