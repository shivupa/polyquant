...
fp22 = fp23 + src2[((hsi*10+4)*1+lsi)*1];
...
fp33 = fp34 + src2[((hsi*10+8)*1+lsi)*1];
...
fp39 = fp40 + src2[((hsi*10+7)*1+lsi)*1];
...
fp45 = 0.0000000000000000e+00 + src2[((hsi*10+1)*1+lsi)*1];
...
fp54 = 0.0000000000000000e+00 + src2[((hsi*10+0)*1+lsi)*1];
...
fp59 = fp60 + src2[((hsi*10+2)*1+lsi)*1];
...
fp72 = inteval->PA_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
