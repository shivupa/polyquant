...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_1_c_2_c_0_Sb__i__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp29 = 0.0000000000000000e+00 + src1[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp30;
fp30 = 0.0000000000000000e+00 + src1[((hsi*10+6)*1+lsi)*1];
...
fp23 = 0.0000000000000000e+00 + src1[((hsi*10+3)*1+lsi)*1];
...
fp13 = 0.0000000000000000e+00 + src1[((hsi*10+4)*1+lsi)*1];
