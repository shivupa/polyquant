...
fp3 = inteval->WP_z[vi] * src1[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp4;
fp4 = inteval->PA_z[vi] * src0[((hsi*3+1)*1+lsi)*1];
...
fp11 = inteval->WP_y[vi] * src1[((hsi*3+0)*1+lsi)*1];
...
fp18 = inteval->WP_z[vi] * src1[((hsi*3+2)*1+lsi)*1];
LIBINT2_REALTYPE fp19;
fp19 = inteval->PA_z[vi] * src0[((hsi*3+2)*1+lsi)*1];
