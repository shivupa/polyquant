...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__s__1___TwoPRep_s__0__s100__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp7 = inteval->alpha4_over_zetapluseta[vi] * src2[((hsi*1+0)*1+lsi)*1];
