...
fp6 = inteval->PB_z[vi] * src0[((hsi*10+9)*1+lsi)*1];
...
fp12 = inteval->PB_z[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp26 = inteval->PB_z[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp33 = inteval->PB_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp47 = inteval->PB_z[vi] * src0[((hsi*10+7)*1+lsi)*1];
...
fp57 = inteval->PB_y[vi] * src0[((hsi*10+5)*1+lsi)*1];
...
fp60 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp63 = inteval->PB_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
