...
extern "C" {
#endif
void CR_aB_X2__0___Overlap_X2__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp16 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*9+1)*1+lsi)*1], fp20);
...
fp19 = libint2::fma_plus(inteval->PB_x[vi], target[((hsi*9+1)*1+lsi)*1], fp20);
...
fp12 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*9+2)*1+lsi)*1], fp13);
...
fp2 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*9+5)*1+lsi)*1], fp3);
...
fp7 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*9+4)*1+lsi)*1], fp8);
LIBINT2_REALTYPE fp5;
fp5 = fp7 + fp6;
target[((hsi*9+7)*1+lsi)*1] = fp5;
LIBINT2_REALTYPE fp11;
LIBINT2_REALTYPE fp10;
fp10 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*9+3)*1+lsi)*1], fp20);
