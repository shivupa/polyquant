...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_1_c_0_c_2_Sb__k__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp49 = 0.0000000000000000e+00 + src1[((hsi*11+1)*1+lsi)*1];
...
fp47 = 0.0000000000000000e+00 + src1[((hsi*11+2)*1+lsi)*1];
...
fp46 = 0.0000000000000000e+00 + src1[((hsi*11+5)*1+lsi)*1];
...
fp48 = 0.0000000000000000e+00 + src1[((hsi*11+6)*1+lsi)*1];
...
fp50 = 0.0000000000000000e+00 + src1[((hsi*11+7)*1+lsi)*1];
...
fp45 = 0.0000000000000000e+00 + src1[((hsi*11+3)*1+lsi)*1];
...
fp44 = 0.0000000000000000e+00 + src1[((hsi*11+4)*1+lsi)*1];
