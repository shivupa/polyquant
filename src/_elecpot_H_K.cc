...
HRRPart0ket0bra0np(inteval, &(inteval->stack[((hsi*198+1697)*1+lsi)*1]), &(inteval->stack[((hsi*78+91)*1+lsi)*1]), &(inteval->stack[((hsi*66+169)*1+lsi)*1]),1);
...
HRRPart0ket0bra0op(inteval, &(inteval->stack[((hsi*234+2675)*1+lsi)*1]), &(inteval->stack[((hsi*91+0)*1+lsi)*1]), &(inteval->stack[((hsi*78+91)*1+lsi)*1]),1);
HRRPart0ket0bra0nd(inteval, &(inteval->stack[((hsi*396+2909)*1+lsi)*1]), &(inteval->stack[((hsi*234+2675)*1+lsi)*1]), &(inteval->stack[((hsi*198+1697)*1+lsi)*1]),1);
