...
extern "C" {
#endif
void CR_aB_Y3__0___Overlap_Y0__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp4 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*4+1)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*4+2)*1+lsi)*1], fp1);
