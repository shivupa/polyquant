...
extern "C" {
#endif
void _aB_P__0__I__1___TwoPRep_S__0__I__1___Ab__up_0(const Libint_t* inteval) {
...
_aB_P__0__I__1___TwoPRep_S__0__I__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
HRRPart1bra0ket0np(inteval, &(inteval->stack[((hsi*594+7311)*1+lsi)*1]), &(inteval->stack[((hsi*234+273)*1+lsi)*1]), &(inteval->stack[((hsi*198+507)*1+lsi)*1]),3);
...
HRRPart1bra0ket0op(inteval, &(inteval->stack[((hsi*702+3549)*1+lsi)*1]), &(inteval->stack[((hsi*273+0)*1+lsi)*1]), &(inteval->stack[((hsi*234+273)*1+lsi)*1]),3);
HRRPart1bra0ket0nd(inteval, &(inteval->stack[((hsi*1188+0)*1+lsi)*1]), &(inteval->stack[((hsi*702+3549)*1+lsi)*1]), &(inteval->stack[((hsi*594+7311)*1+lsi)*1]),3);
