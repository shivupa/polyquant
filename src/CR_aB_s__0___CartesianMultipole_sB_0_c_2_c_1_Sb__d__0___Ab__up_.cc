...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_0_c_2_c_1_Sb__d__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp16 = libint2::fma_plus(inteval->BO_y[vi], fp20, fp13);
...
fp12 = 0.0000000000000000e+00 + src1[((hsi*6+4)*1+lsi)*1];
