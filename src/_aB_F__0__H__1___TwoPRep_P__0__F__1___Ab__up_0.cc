...
{
const int vi = 0;
HRRPart1bra0ket0ip(inteval, &(inteval->stack[((hsi*840+9550)*1+lsi)*1]), &(inteval->stack[((hsi*360+2400)*1+lsi)*1]), &(inteval->stack[((hsi*280+2760)*1+lsi)*1]),10);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*630+10390)*1+lsi)*1]), &(inteval->stack[((hsi*280+2760)*1+lsi)*1]), &(inteval->stack[((hsi*210+3040)*1+lsi)*1]),10);
...
HRRPart1bra0ket0kp(inteval, &(inteval->stack[((hsi*1080+12280)*1+lsi)*1]), &(inteval->stack[((hsi*450+1950)*1+lsi)*1]), &(inteval->stack[((hsi*360+2400)*1+lsi)*1]),10);
...
HRRPart1bra0ket0ip(inteval, &(inteval->stack[((hsi*1260+9550)*1+lsi)*1]), &(inteval->stack[((hsi*540+675)*1+lsi)*1]), &(inteval->stack[((hsi*420+1215)*1+lsi)*1]),15);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*945+10810)*1+lsi)*1]), &(inteval->stack[((hsi*420+1215)*1+lsi)*1]), &(inteval->stack[((hsi*315+1635)*1+lsi)*1]),15);
...
HRRPart1bra0ket0id(inteval, &(inteval->stack[((hsi*2520+17140)*1+lsi)*1]), &(inteval->stack[((hsi*1620+1215)*1+lsi)*1]), &(inteval->stack[((hsi*1260+9550)*1+lsi)*1]),15);
