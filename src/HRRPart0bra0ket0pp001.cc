...
extern "C" {
#endif
void HRRPart0bra0ket0pp001(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp2 = src0[((hsi*6+2)*lowdim+lsi)*1] + fp3;
...
fp10 = src0[((hsi*6+5)*lowdim+lsi)*1] + fp11;
...
fp18 = src0[((hsi*6+4)*lowdim+lsi)*1] + fp19;
