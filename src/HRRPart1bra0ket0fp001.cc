...
extern "C" {
#endif
void HRRPart1bra0ket0fp001(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int highdim) {
...
fp74 = src0[((hsi*15+4)*1+lsi)*1] + fp75;
...
fp66 = src0[((hsi*15+6)*1+lsi)*1] + fp67;
...
fp58 = src0[((hsi*15+2)*1+lsi)*1] + fp59;
...
fp50 = src0[((hsi*15+12)*1+lsi)*1] + fp51;
...
fp42 = src0[((hsi*15+10)*1+lsi)*1] + fp43;
...
fp34 = src0[((hsi*15+13)*1+lsi)*1] + fp35;
...
fp18 = src0[((hsi*15+7)*1+lsi)*1] + fp19;
