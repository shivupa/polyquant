...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_1_c_1_Sb__p__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
...
fp2 = libint2::fma_plus(inteval->PB_x[vi], src0[((hsi*1+0)*1+lsi)*1], fp3);
