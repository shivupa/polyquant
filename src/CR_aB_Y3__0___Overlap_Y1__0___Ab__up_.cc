...
extern "C" {
#endif
void CR_aB_Y3__0___Overlap_Y1__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp14 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*8+2)*1+lsi)*1], fp17);
...
fp16 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*8+1)*1+lsi)*1], fp17);
...
fp11 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*8+3)*1+lsi)*1], fp12);
...
fp2 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*8+5)*1+lsi)*1], fp3);
...
fp5 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*8+4)*1+lsi)*1], fp6);
