...
extern "C" {
#endif
void HRRPart0bra0ket0f100p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp75 = inteval->AB_y[vi] * src1[((hsi*10+0)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp74;
fp74 = src0[((hsi*15+3)*lowdim+lsi)*1] + fp75;
...
fp69 = 1.0000000000000000e+00 * src2[((hsi*10+1)*lowdim+lsi)*1];
...
fp68 = fp70 + fp69;
target[((hsi*30+3)*lowdim+lsi)*1] = fp68;
LIBINT2_REALTYPE fp67;
fp67 = inteval->AB_y[vi] * src1[((hsi*10+1)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp66;
fp66 = src0[((hsi*15+1)*lowdim+lsi)*1] + fp67;
...
fp61 = 1.0000000000000000e+00 * src2[((hsi*10+2)*lowdim+lsi)*1];
...
fp60 = fp62 + fp61;
target[((hsi*30+6)*lowdim+lsi)*1] = fp60;
LIBINT2_REALTYPE fp59;
fp59 = inteval->AB_y[vi] * src1[((hsi*10+2)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp58;
fp58 = src0[((hsi*15+8)*lowdim+lsi)*1] + fp59;
...
fp53 = 1.0000000000000000e+00 * src2[((hsi*10+3)*lowdim+lsi)*1];
...
fp52 = fp54 + fp53;
target[((hsi*30+9)*lowdim+lsi)*1] = fp52;
LIBINT2_REALTYPE fp51;
fp51 = inteval->AB_y[vi] * src1[((hsi*10+3)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp50;
fp50 = src0[((hsi*15+9)*lowdim+lsi)*1] + fp51;
...
fp45 = 1.0000000000000000e+00 * src2[((hsi*10+4)*lowdim+lsi)*1];
...
fp44 = fp46 + fp45;
target[((hsi*30+12)*lowdim+lsi)*1] = fp44;
LIBINT2_REALTYPE fp43;
fp43 = inteval->AB_y[vi] * src1[((hsi*10+4)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp42;
fp42 = src0[((hsi*15+12)*lowdim+lsi)*1] + fp43;
...
fp35 = inteval->AB_y[vi] * src1[((hsi*10+5)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp34;
fp34 = src0[((hsi*15+5)*lowdim+lsi)*1] + fp35;
...
fp29 = 1.0000000000000000e+00 * src2[((hsi*10+6)*lowdim+lsi)*1];
...
fp28 = fp30 + fp29;
target[((hsi*30+18)*lowdim+lsi)*1] = fp28;
LIBINT2_REALTYPE fp27;
fp27 = inteval->AB_y[vi] * src1[((hsi*10+6)*lowdim+lsi)*1];
...
fp21 = 1.0000000000000000e+00 * src2[((hsi*10+7)*lowdim+lsi)*1];
...
fp20 = fp22 + fp21;
target[((hsi*30+21)*lowdim+lsi)*1] = fp20;
LIBINT2_REALTYPE fp19;
fp19 = inteval->AB_y[vi] * src1[((hsi*10+7)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp18;
fp18 = src0[((hsi*15+14)*lowdim+lsi)*1] + fp19;
...
fp12 = fp14 + fp13;
target[((hsi*30+24)*lowdim+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
fp11 = inteval->AB_y[vi] * src1[((hsi*10+8)*lowdim+lsi)*1];
LIBINT2_REALTYPE fp10;
fp10 = src0[((hsi*15+11)*lowdim+lsi)*1] + fp11;
