...
fp42 = src0[((hsi*10+3)*lowdim+lsi)*1] + fp43;
...
fp34 = src0[((hsi*10+1)*lowdim+lsi)*1] + fp35;
...
fp26 = src0[((hsi*10+8)*lowdim+lsi)*1] + fp27;
...
fp18 = src0[((hsi*10+5)*lowdim+lsi)*1] + fp19;
...
fp10 = src0[((hsi*10+9)*lowdim+lsi)*1] + fp11;
