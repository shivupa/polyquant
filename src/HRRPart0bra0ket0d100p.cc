...
extern "C" {
#endif
void HRRPart0bra0ket0d100p(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, int lowdim) {
...
fp42 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+0)*lowdim+lsi)*1], src0[((hsi*10+3)*lowdim+lsi)*1]);
...
fp34 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+1)*lowdim+lsi)*1], src0[((hsi*10+1)*lowdim+lsi)*1]);
...
fp26 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+2)*lowdim+lsi)*1], src0[((hsi*10+8)*lowdim+lsi)*1]);
...
fp18 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+3)*lowdim+lsi)*1], src0[((hsi*10+5)*lowdim+lsi)*1]);
...
fp10 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+4)*lowdim+lsi)*1], src0[((hsi*10+9)*lowdim+lsi)*1]);
