...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__d__1___TwoPRep_s__0__s001__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp73 = inteval->WP_x[vi] * src1[((hsi*6+2)*1+lsi)*1];
LIBINT2_REALTYPE fp74;
fp74 = inteval->PA_x[vi] * src0[((hsi*6+2)*1+lsi)*1];
...
fp67 = fp68 * src2[((hsi*3+1)*1+lsi)*1];
...
fp62 = fp68 * src2[((hsi*3+2)*1+lsi)*1];
LIBINT2_REALTYPE fp64;
fp64 = inteval->WP_x[vi] * src1[((hsi*6+4)*1+lsi)*1];
LIBINT2_REALTYPE fp65;
fp65 = inteval->PA_x[vi] * src0[((hsi*6+4)*1+lsi)*1];
...
fp51 = fp80 * src2[((hsi*3+1)*1+lsi)*1];
...
fp37 = inteval->WP_y[vi] * src1[((hsi*6+5)*1+lsi)*1];
LIBINT2_REALTYPE fp38;
fp38 = inteval->PA_y[vi] * src0[((hsi*6+5)*1+lsi)*1];
...
fp18 = fp31 * src3[((hsi*6+2)*1+lsi)*1];
LIBINT2_REALTYPE fp20;
fp20 = fp80 * src2[((hsi*3+2)*1+lsi)*1];
...
fp13 = fp31 * src3[((hsi*6+3)*1+lsi)*1];
...
fp7 = fp31 * src3[((hsi*6+4)*1+lsi)*1];
LIBINT2_REALTYPE fp43;
fp43 = fp68 * src2[((hsi*3+0)*1+lsi)*1];
