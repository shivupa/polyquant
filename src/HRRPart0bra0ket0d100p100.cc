...
extern "C" {
#endif
void HRRPart0bra0ket0d100p100(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, int lowdim) {
...
fp52 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+0)*lowdim+lsi)*1], src0[((hsi*10+3)*lowdim+lsi)*1]);
...
fp45 = 1.0000000000000000e+00 * src3[((hsi*6+1)*lowdim+lsi)*1];
...
fp44 = fp46 - fp45;
target[((hsi*18+3)*lowdim+lsi)*1] = fp44;
LIBINT2_REALTYPE fp43;
LIBINT2_REALTYPE fp42;
fp42 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+1)*lowdim+lsi)*1], src0[((hsi*10+1)*lowdim+lsi)*1]);
...
fp35 = 1.0000000000000000e+00 * src3[((hsi*6+2)*lowdim+lsi)*1];
...
fp34 = fp36 - fp35;
target[((hsi*18+6)*lowdim+lsi)*1] = fp34;
LIBINT2_REALTYPE fp33;
LIBINT2_REALTYPE fp32;
fp32 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+2)*lowdim+lsi)*1], src0[((hsi*10+8)*lowdim+lsi)*1]);
...
fp55 = 1.0000000000000000e+00 * src3[((hsi*6+0)*lowdim+lsi)*1];
...
fp54 = fp56 - fp55;
target[((hsi*18+0)*lowdim+lsi)*1] = fp54;
LIBINT2_REALTYPE fp23;
LIBINT2_REALTYPE fp22;
fp22 = libint2::fma_plus(inteval->AB_y[vi], src1[((hsi*6+3)*lowdim+lsi)*1], src0[((hsi*10+5)*lowdim+lsi)*1]);
...
fp15 = 1.0000000000000000e+00 * src3[((hsi*6+4)*lowdim+lsi)*1];
...
fp5 = 1.0000000000000000e+00 * src3[((hsi*6+5)*lowdim+lsi)*1];
...
fp25 = 1.0000000000000000e+00 * src3[((hsi*6+3)*lowdim+lsi)*1];
...
fp24 = fp26 - fp25;
target[((hsi*18+9)*lowdim+lsi)*1] = fp24;
}
}
}
const int hsi = 0;
