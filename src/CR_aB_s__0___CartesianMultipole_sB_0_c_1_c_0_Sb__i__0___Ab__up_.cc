...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_0_c_1_c_0_Sb__i__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp21 = 0.0000000000000000e+00 + src1[((hsi*8+7)*1+lsi)*1];
...
fp26 = 0.0000000000000000e+00 + src1[((hsi*8+0)*1+lsi)*1];
...
fp15 = 0.0000000000000000e+00 + src1[((hsi*8+5)*1+lsi)*1];
