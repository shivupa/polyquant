...
extern "C" {
#endif
void OSVRRP1InBra_aB_s100__0__h__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp96 = inteval->roe[vi] * src2[((hsi*10+0)*1+lsi)*1];
...
fp98 = inteval->WQ_x[vi] * src0[((hsi*15+0)*1+lsi)*1];
