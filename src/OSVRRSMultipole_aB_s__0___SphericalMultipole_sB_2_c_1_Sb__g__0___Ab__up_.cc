...
fp30 = inteval->PB_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp36 = inteval->PB_z[vi] * src0[((hsi*10+8)*1+lsi)*1];
...
fp42 = inteval->PB_z[vi] * src0[((hsi*10+7)*1+lsi)*1];
...
fp55 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp52;
fp52 = fp55 + fp53;
target[((hsi*15+4)*1+lsi)*1] = fp52;
LIBINT2_REALTYPE fp56;
fp56 = inteval->PB_y[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp62 = inteval->PB_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
...
fp67 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
