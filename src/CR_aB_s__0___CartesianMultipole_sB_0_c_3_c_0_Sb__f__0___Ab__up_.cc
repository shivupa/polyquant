...
fp22 = inteval->BO_y[vi] * fp15;
LIBINT2_REALTYPE fp18;
fp18 = inteval->BO_y[vi] * fp13;
LIBINT2_REALTYPE fp14;
fp14 = 0.0000000000000000e+00 + src1[((hsi*7+6)*1+lsi)*1];
