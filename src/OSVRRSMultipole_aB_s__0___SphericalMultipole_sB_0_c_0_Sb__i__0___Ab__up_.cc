...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_0_c_0_Sb__i__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
...
fp106 = inteval->PB_y[vi] * src0[((hsi*21+1)*1+lsi)*1];
...
fp101 = inteval->PB_z[vi] * src0[((hsi*21+2)*1+lsi)*1];
...
fp94 = inteval->PB_y[vi] * src0[((hsi*21+5)*1+lsi)*1];
...
fp88 = inteval->PB_z[vi] * src0[((hsi*21+7)*1+lsi)*1];
...
fp78 = inteval->PB_y[vi] * src0[((hsi*21+3)*1+lsi)*1];
...
fp73 = inteval->PB_z[vi] * src0[((hsi*21+4)*1+lsi)*1];
...
fp67 = inteval->PB_y[vi] * src0[((hsi*21+12)*1+lsi)*1];
...
fp62 = inteval->PB_z[vi] * src0[((hsi*21+6)*1+lsi)*1];
...
fp111 = inteval->PB_x[vi] * src0[((hsi*21+0)*1+lsi)*1];
...
fp56 = inteval->PB_z[vi] * src0[((hsi*21+15)*1+lsi)*1];
...
fp51 = inteval->PB_z[vi] * src0[((hsi*21+16)*1+lsi)*1];
...
fp46 = inteval->PB_z[vi] * src0[((hsi*21+17)*1+lsi)*1];
...
fp41 = inteval->PB_y[vi] * src0[((hsi*21+9)*1+lsi)*1];
