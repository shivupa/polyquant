...
extern "C" {
#endif
void CR_aB_Y0__0___Overlap_Y9__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp31 = inteval->PB_y[vi] * target[((hsi*10+0)*1+lsi)*1];
...
fp28 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+1)*1+lsi)*1], fp29);
target[((hsi*10+2)*1+lsi)*1] = fp28;
LIBINT2_REALTYPE fp27;
LIBINT2_REALTYPE fp24;
fp24 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+2)*1+lsi)*1], fp25);
...
fp20 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+3)*1+lsi)*1], fp21);
target[((hsi*10+4)*1+lsi)*1] = fp20;
LIBINT2_REALTYPE fp19;
LIBINT2_REALTYPE fp16;
fp16 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+4)*1+lsi)*1], fp17);
...
fp12 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+5)*1+lsi)*1], fp13);
target[((hsi*10+6)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
LIBINT2_REALTYPE fp8;
fp8 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+6)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+7)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+8)*1+lsi)*1], fp1);
