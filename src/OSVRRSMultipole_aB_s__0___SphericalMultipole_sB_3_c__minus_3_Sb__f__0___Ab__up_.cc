...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_3_c__minus_3_Sb__f__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp8 = inteval->PB_z[vi] * src0[((hsi*6+4)*1+lsi)*1];
...
fp16 = inteval->PB_y[vi] * src0[((hsi*6+3)*1+lsi)*1];
...
fp34 = inteval->PB_y[vi] * src0[((hsi*6+1)*1+lsi)*1];
