...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_4_c__minus_3_Sb__g__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4) {
...
fp32 = inteval->PB_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp35 = fp36 + src4[((hsi*10+8)*1+lsi)*1];
LIBINT2_REALTYPE fp34;
fp34 = inteval->oo2z[vi] * fp35;
LIBINT2_REALTYPE fp38;
fp38 = inteval->PB_z[vi] * src0[((hsi*10+8)*1+lsi)*1];
...
fp41 = fp42 + src4[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp40;
fp40 = inteval->oo2z[vi] * fp41;
LIBINT2_REALTYPE fp44;
fp44 = inteval->PB_z[vi] * src0[((hsi*10+7)*1+lsi)*1];
LIBINT2_REALTYPE fp39;
fp39 = fp44 + fp40;
target[((hsi*15+7)*1+lsi)*1] = fp39;
LIBINT2_REALTYPE fp47;
fp47 = 0.0000000000000000e+00 + src4[((hsi*10+1)*1+lsi)*1];
LIBINT2_REALTYPE fp46;
fp46 = inteval->oo2z[vi] * fp47;
LIBINT2_REALTYPE fp48;
fp48 = inteval->PB_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp55 = inteval->PB_y[vi] * src0[((hsi*10+5)*1+lsi)*1];
...
fp59 = inteval->PB_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp56;
fp56 = fp59 + fp57;
target[((hsi*15+4)*1+lsi)*1] = fp56;
LIBINT2_REALTYPE fp63;
fp63 = -5.0000000000000000e-01 * src3[((hsi*10+0)*1+lsi)*1];
...
fp67 = fp68 + src4[((hsi*10+2)*1+lsi)*1];
LIBINT2_REALTYPE fp66;
fp66 = inteval->oo2z[vi] * fp67;
LIBINT2_REALTYPE fp70;
fp70 = inteval->PB_z[vi] * src0[((hsi*10+2)*1+lsi)*1];
LIBINT2_REALTYPE fp65;
fp65 = fp70 + fp66;
target[((hsi*15+2)*1+lsi)*1] = fp65;
LIBINT2_REALTYPE fp74;
fp74 = -5.0000000000000000e-01 * src3[((hsi*10+1)*1+lsi)*1];
...
fp77 = inteval->PB_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
