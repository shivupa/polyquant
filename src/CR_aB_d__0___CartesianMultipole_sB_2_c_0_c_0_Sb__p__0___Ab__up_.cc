...
fp43 = libint2::fma_plus(inteval->BO_x[vi], fp41, fp50);
...
fp29 = libint2::fma_plus(inteval->BO_x[vi], fp27, fp36);
...
fp18 = 0.0000000000000000e+00 + src0[((hsi*12+6)*1+lsi)*1];
...
fp15 = libint2::fma_plus(inteval->BO_x[vi], fp13, fp22);
