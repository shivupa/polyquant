...
extern "C" {
#endif
void CR_aB_Z0__0___Overlap_Z7__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp20 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+1)*1+lsi)*1], fp21);
target[((hsi*8+2)*1+lsi)*1] = fp20;
LIBINT2_REALTYPE fp19;
LIBINT2_REALTYPE fp16;
fp16 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+2)*1+lsi)*1], fp17);
...
fp12 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+3)*1+lsi)*1], fp13);
target[((hsi*8+4)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
LIBINT2_REALTYPE fp8;
fp8 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+4)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+5)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+6)*1+lsi)*1], fp1);
