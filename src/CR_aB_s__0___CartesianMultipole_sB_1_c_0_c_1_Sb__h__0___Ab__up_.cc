...
extern "C" {
#endif
void CR_aB_s__0___CartesianMultipole_sB_1_c_0_c_1_Sb__h__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp15 = 0.0000000000000000e+00 + src2[((hsi*8+1)*1+lsi)*1];
...
fp20 = 0.0000000000000000e+00 + src1[((hsi*8+2)*1+lsi)*1];
...
fp19 = 0.0000000000000000e+00 + src1[((hsi*8+3)*1+lsi)*1];
