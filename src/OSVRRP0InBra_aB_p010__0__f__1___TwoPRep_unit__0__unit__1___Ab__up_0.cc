...
extern "C" {
#endif
void OSVRRP0InBra_aB_p010__0__f__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp62 = fp91 * src1[((hsi*6+1)*1+lsi)*1];
...
fp50 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*10+3)*1+lsi)*1];
LIBINT2_REALTYPE fp49;
fp49 = 1.0000000000000000e+00 * fp50;
LIBINT2_REALTYPE fp52;
fp52 = fp78 * src1[((hsi*6+0)*1+lsi)*1];
...
fp46 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*10+4)*1+lsi)*1];
LIBINT2_REALTYPE fp45;
fp45 = 1.0000000000000000e+00 * fp46;
LIBINT2_REALTYPE fp47;
fp47 = inteval->WP_y[vi] * src0[((hsi*10+4)*1+lsi)*1];
LIBINT2_REALTYPE fp44;
fp44 = fp47 - fp45;
target[((hsi*30+14)*1+lsi)*1] = fp44;
...
fp37 = fp85 * src1[((hsi*6+5)*1+lsi)*1];
...
fp31 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*10+7)*1+lsi)*1];
...
fp26 = inteval->alpha1_rho_over_zeta2[vi] * src2[((hsi*10+8)*1+lsi)*1];
LIBINT2_REALTYPE fp25;
fp25 = 1.0000000000000000e+00 * fp26;
LIBINT2_REALTYPE fp28;
fp28 = inteval->WP_y[vi] * src0[((hsi*10+8)*1+lsi)*1];
...
fp22 = fp78 * src1[((hsi*6+4)*1+lsi)*1];
...
fp43 = inteval->WP_y[vi] * src0[((hsi*10+5)*1+lsi)*1];
