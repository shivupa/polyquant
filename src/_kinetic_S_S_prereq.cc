...
fp18 = 0.0000000000000000e+00 + inteval->_0_Overlap_0_z[vi];
...
fp15 = libint2::fma_plus(inteval->PA_z[vi], fp14, fp16);
...
fp20 = libint2::fma_plus(inteval->PA_y[vi], fp19, fp21);
...
fp9 = libint2::fma_plus(fp13, fp18, fp10);
