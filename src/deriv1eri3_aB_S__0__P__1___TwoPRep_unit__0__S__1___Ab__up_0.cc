...
extern "C" {
#endif
void deriv1eri3_aB_S__0__P__1___TwoPRep_unit__0__S__1___Ab__up_0(const Libint_t* inteval) {
...
deriv1eri3_aB_S__0__P__1___TwoPRep_unit__0__S__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
