...
fp74 = src0[((hsi*21+14)*lowdim+lsi)*1] + fp75;
...
fp82 = src0[((hsi*21+10)*lowdim+lsi)*1] + fp83;
...
fp98 = src0[((hsi*21+2)*lowdim+lsi)*1] + fp99;
...
fp114 = src0[((hsi*21+4)*lowdim+lsi)*1] + fp115;
...
fp2 = src0[((hsi*21+17)*lowdim+lsi)*1] + fp3;
...
fp10 = src0[((hsi*21+20)*lowdim+lsi)*1] + fp11;
...
fp18 = src0[((hsi*21+19)*lowdim+lsi)*1] + fp19;
...
fp26 = src0[((hsi*21+16)*lowdim+lsi)*1] + fp27;
...
fp34 = src0[((hsi*21+15)*lowdim+lsi)*1] + fp35;
...
fp42 = src0[((hsi*21+18)*lowdim+lsi)*1] + fp43;
...
fp50 = src0[((hsi*21+8)*lowdim+lsi)*1] + fp51;
...
fp58 = src0[((hsi*21+7)*lowdim+lsi)*1] + fp59;
