...
extern "C" {
#endif
void OSVRRSMultipole_aB_s__0___SphericalMultipole_sB_4_c__minus_1_Sb__g__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3, const LIBINT2_REALTYPE* src4, const LIBINT2_REALTYPE* src5) {
...
fp37 = fp38 + src5[((hsi*10+8)*1+lsi)*1];
...
fp43 = fp44 + src5[((hsi*10+7)*1+lsi)*1];
...
fp49 = 0.0000000000000000e+00 + src5[((hsi*10+1)*1+lsi)*1];
...
fp62 = 0.0000000000000000e+00 + src5[((hsi*10+0)*1+lsi)*1];
...
fp67 = -5.0000000000000000e-01 * src4[((hsi*10+0)*1+lsi)*1];
...
fp73 = fp74 + src5[((hsi*10+2)*1+lsi)*1];
