...
extern "C" {
#endif
void CR_DerivGaussP0InBra_aB_g100__0__s__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1) {
...
fp2 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+19)*1+lsi)*1];
...
fp5 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+18)*1+lsi)*1];
...
fp8 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+11)*1+lsi)*1];
...
fp12 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+10)*1+lsi)*1];
...
fp15 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+9)*1+lsi)*1];
...
fp19 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+15)*1+lsi)*1];
...
fp23 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+12)*1+lsi)*1];
...
fp26 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+4)*1+lsi)*1];
...
fp29 = inteval->two_alpha0_bra[vi] * src0[((hsi*21+3)*1+lsi)*1];
