...
extern "C" {
#endif
void CR_aB_Z6__0___Overlap_Z0__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0) {
...
fp19 = inteval->PA_z[vi] * target[((hsi*7+0)*1+lsi)*1];
target[((hsi*7+1)*1+lsi)*1] = fp19;
LIBINT2_REALTYPE fp18;
LIBINT2_REALTYPE fp16;
fp16 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*7+1)*1+lsi)*1], fp17);
...
fp12 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*7+2)*1+lsi)*1], fp13);
target[((hsi*7+3)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp11;
LIBINT2_REALTYPE fp8;
fp8 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*7+3)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*7+4)*1+lsi)*1], fp5);
...
fp0 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*7+5)*1+lsi)*1], fp1);
