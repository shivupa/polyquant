...
extern "C" {
#endif
void OSVRRP1InBra_aB_s100__0__f__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp21 = inteval->roe[vi] * src2[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp20;
fp20 = src1[((hsi*3+1)*1+lsi)*1] - fp21;
LIBINT2_REALTYPE fp9;
fp9 = 1.0000000000000000e+00 * inteval->oo2e[vi];
...
fp10 = inteval->WQ_y[vi] * src0[((hsi*6+3)*1+lsi)*1];
LIBINT2_REALTYPE fp7;
fp7 = fp10 + fp8;
target[((hsi*10+5)*1+lsi)*1] = fp7;
LIBINT2_REALTYPE fp11;
fp11 = inteval->WQ_z[vi] * src0[((hsi*6+0)*1+lsi)*1];
target[((hsi*10+4)*1+lsi)*1] = fp11;
LIBINT2_REALTYPE fp12;
fp12 = inteval->WQ_y[vi] * src0[((hsi*6+0)*1+lsi)*1];
target[((hsi*10+3)*1+lsi)*1] = fp12;
LIBINT2_REALTYPE fp30;
fp30 = 2.0000000000000000e+00 * inteval->oo2e[vi];
LIBINT2_REALTYPE fp16;
fp16 = inteval->roe[vi] * src2[((hsi*3+2)*1+lsi)*1];
...
fp22 = inteval->WQ_y[vi] * src0[((hsi*6+1)*1+lsi)*1];
