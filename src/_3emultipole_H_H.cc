...
extern "C" {
#endif
void _3emultipole_H_H(const Libint_t* inteval) {
...
_3emultipole_H_H_prereq(inteval+c, inteval->stack);
}
...
inteval->targets[6] = &(inteval->stack[((hsi*441+2646)*1+lsi)*1]);
inteval->targets[7] = &(inteval->stack[((hsi*441+3087)*1+lsi)*1]);
inteval->targets[8] = &(inteval->stack[((hsi*441+3528)*1+lsi)*1]);
inteval->targets[9] = &(inteval->stack[((hsi*441+3969)*1+lsi)*1]);
inteval->targets[10] = &(inteval->stack[((hsi*441+4410)*1+lsi)*1]);
inteval->targets[11] = &(inteval->stack[((hsi*441+4851)*1+lsi)*1]);
