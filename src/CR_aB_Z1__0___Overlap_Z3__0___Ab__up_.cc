...
fp13 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+1)*1+lsi)*1], fp14);
...
fp9 = libint2::fma_plus(inteval->PB_z[vi], target[((hsi*8+2)*1+lsi)*1], fp10);
...
fp0 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*8+3)*1+lsi)*1], fp1);
target[((hsi*8+7)*1+lsi)*1] = fp0;
LIBINT2_REALTYPE fp5;
LIBINT2_REALTYPE fp4;
fp4 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*8+2)*1+lsi)*1], fp10);
target[((hsi*8+6)*1+lsi)*1] = fp4;
LIBINT2_REALTYPE fp7;
LIBINT2_REALTYPE fp6;
fp6 = libint2::fma_plus(inteval->PA_z[vi], target[((hsi*8+1)*1+lsi)*1], fp14);
