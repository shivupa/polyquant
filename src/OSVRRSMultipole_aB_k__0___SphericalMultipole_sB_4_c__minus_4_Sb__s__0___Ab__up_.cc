...
extern "C" {
#endif
void OSVRRSMultipole_aB_k__0___SphericalMultipole_sB_4_c__minus_4_Sb__s__0___Ab__up_(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2, const LIBINT2_REALTYPE* src3) {
...
fp86 = inteval->PA_z[vi] * src0[((hsi*28+17)*1+lsi)*1];
...
fp91 = inteval->PA_z[vi] * src0[((hsi*28+16)*1+lsi)*1];
...
fp96 = inteval->PA_z[vi] * src0[((hsi*28+15)*1+lsi)*1];
...
fp102 = inteval->PA_z[vi] * src0[((hsi*28+6)*1+lsi)*1];
...
fp109 = inteval->PA_y[vi] * src0[((hsi*28+12)*1+lsi)*1];
...
fp115 = inteval->PA_z[vi] * src0[((hsi*28+4)*1+lsi)*1];
...
fp132 = inteval->PA_z[vi] * src0[((hsi*28+7)*1+lsi)*1];
...
fp140 = inteval->PA_y[vi] * src0[((hsi*28+5)*1+lsi)*1];
...
fp146 = inteval->PA_y[vi] * src0[((hsi*28+0)*1+lsi)*1];
...
fp151 = inteval->PA_z[vi] * src0[((hsi*28+2)*1+lsi)*1];
...
fp158 = inteval->PA_y[vi] * src0[((hsi*28+1)*1+lsi)*1];
...
fp122 = inteval->PA_y[vi] * src0[((hsi*28+3)*1+lsi)*1];
...
fp81 = inteval->PA_y[vi] * src0[((hsi*28+9)*1+lsi)*1];
...
fp63 = inteval->PA_y[vi] * src0[((hsi*28+18)*1+lsi)*1];
...
fp68 = inteval->PA_z[vi] * src0[((hsi*28+11)*1+lsi)*1];
...
fp74 = inteval->PA_z[vi] * src0[((hsi*28+10)*1+lsi)*1];
