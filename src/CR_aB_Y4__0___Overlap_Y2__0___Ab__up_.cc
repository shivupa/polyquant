...
fp67 = inteval->PB_y[vi] * target[((hsi*15+0)*1+lsi)*1];
target[((hsi*15+1)*1+lsi)*1] = fp67;
LIBINT2_REALTYPE fp62;
fp62 = inteval->PA_y[vi] * target[((hsi*15+0)*1+lsi)*1];
...
fp61 = inteval->PA_y[vi] * target[((hsi*15+1)*1+lsi)*1];
LIBINT2_REALTYPE fp58;
fp58 = fp61 + fp59;
target[((hsi*15+4)*1+lsi)*1] = fp58;
LIBINT2_REALTYPE fp49;
fp49 = inteval->PA_y[vi] * target[((hsi*15+4)*1+lsi)*1];
...
fp53 = inteval->PA_y[vi] * target[((hsi*15+3)*1+lsi)*1];
...
fp31 = inteval->PA_y[vi] * target[((hsi*15+7)*1+lsi)*1];
...
fp35 = inteval->PA_y[vi] * target[((hsi*15+6)*1+lsi)*1];
...
fp66 = inteval->PB_y[vi] * target[((hsi*15+1)*1+lsi)*1];
...
fp57 = inteval->PA_y[vi] * target[((hsi*15+2)*1+lsi)*1];
LIBINT2_REALTYPE fp54;
fp54 = fp57 + fp55;
target[((hsi*15+5)*1+lsi)*1] = fp54;
LIBINT2_REALTYPE fp42;
fp42 = inteval->PA_y[vi] * target[((hsi*15+5)*1+lsi)*1];
...
fp24 = inteval->PA_y[vi] * target[((hsi*15+8)*1+lsi)*1];
...
fp6 = inteval->PA_y[vi] * target[((hsi*15+11)*1+lsi)*1];
...
fp13 = inteval->PA_y[vi] * target[((hsi*15+10)*1+lsi)*1];
...
fp17 = inteval->PA_y[vi] * target[((hsi*15+9)*1+lsi)*1];
