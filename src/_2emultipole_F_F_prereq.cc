...
CR_aB_f__0___CartesianMultipole_sB_0_c_1_c_1_Sb__f__0___Ab__up_(inteval, &(stack[((hsi*100+1072)*1+lsi)*1]), &(stack[((hsi*24+1048)*1+lsi)*1]), &(stack[((hsi*24+1024)*1+lsi)*1]), &(stack[((hsi*24+1000)*1+lsi)*1]));
_libint2_static_api_inc1_short_(&(stack[((hsi*100+900)*1+lsi)*1]),&(stack[((hsi*100+1072)*1+lsi)*1]),100);
CR_aB_f__0___CartesianMultipole_sB_1_c_0_c_1_Sb__f__0___Ab__up_(inteval, &(stack[((hsi*100+1172)*1+lsi)*1]), &(stack[((hsi*24+1048)*1+lsi)*1]), &(stack[((hsi*24+1024)*1+lsi)*1]), &(stack[((hsi*24+1000)*1+lsi)*1]));
_libint2_static_api_inc1_short_(&(stack[((hsi*100+800)*1+lsi)*1]),&(stack[((hsi*100+1172)*1+lsi)*1]),100);
CR_aB_f__0___CartesianMultipole_sB_1_c_1_c_0_Sb__f__0___Ab__up_(inteval, &(stack[((hsi*100+1272)*1+lsi)*1]), &(stack[((hsi*24+1048)*1+lsi)*1]), &(stack[((hsi*24+1024)*1+lsi)*1]), &(stack[((hsi*24+1000)*1+lsi)*1]));
_libint2_static_api_inc1_short_(&(stack[((hsi*100+700)*1+lsi)*1]),&(stack[((hsi*100+1272)*1+lsi)*1]),100);
CR_aB_f__0___CartesianMultipole_sB_0_c_0_c_2_Sb__f__0___Ab__up_(inteval, &(stack[((hsi*100+1372)*1+lsi)*1]), &(stack[((hsi*24+1048)*1+lsi)*1]), &(stack[((hsi*24+1024)*1+lsi)*1]), &(stack[((hsi*24+1000)*1+lsi)*1]));
_libint2_static_api_inc1_short_(&(stack[((hsi*100+600)*1+lsi)*1]),&(stack[((hsi*100+1372)*1+lsi)*1]),100);
CR_aB_f__0___CartesianMultipole_sB_0_c_2_c_0_Sb__f__0___Ab__up_(inteval, &(stack[((hsi*100+1472)*1+lsi)*1]), &(stack[((hsi*24+1048)*1+lsi)*1]), &(stack[((hsi*24+1024)*1+lsi)*1]), &(stack[((hsi*24+1000)*1+lsi)*1]));
