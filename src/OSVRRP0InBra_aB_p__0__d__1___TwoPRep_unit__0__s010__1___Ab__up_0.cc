...
extern "C" {
#endif
void OSVRRP0InBra_aB_p__0__d__1___TwoPRep_unit__0__s010__1___Ab__up_0(const Libint_t* inteval, LIBINT2_REALTYPE* target, const LIBINT2_REALTYPE* src0, const LIBINT2_REALTYPE* src1, const LIBINT2_REALTYPE* src2) {
...
fp28 = fp46 * src1[((hsi*3+1)*1+lsi)*1];
...
fp15 = fp32 * src2[((hsi*6+4)*1+lsi)*1];
...
fp20 = fp40 * src1[((hsi*3+0)*1+lsi)*1];
