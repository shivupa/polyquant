...
original_filename = "positron_polyquant.molden"
filename = "new_positron_polyquant.molden"
...
alpha_den_val = pt.cubegen.density(mol, "positrondens_alpha.cube", pyscf.scf.uhf.make_rdm1(mo_coeff, mo_occ)[0] , nx=npts_x, ny=npts_y, nz=npts_z)
beta_den_val = pt.cubegen.density(mol, "positrondens_beta.cube", pyscf.scf.uhf.make_rdm1(mo_coeff, mo_occ)[1] , nx=npts_x, ny=npts_y, nz=npts_z)
