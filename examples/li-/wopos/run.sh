...
~/Documents/qmcpack/build/bin/convert4qmc -orbitals Li_wopos.h5
sed -i 's/blocks">20/blocks">500/' Li_wopos.qmc.in-wfnoj.xml
sed -i 's/steps">50/steps">3000/' Li_wopos.qmc.in-wfnoj.xml
sed -i 's/usedrift">no/usedrift">yes/' Li_wopos.qmc.in-wfnoj.xml

cd pyscf
python Li.py
~/Documents/qmcpack/build/bin/convert4qmc -orbitals Default.h5
sed -i 's/blocks">20/blocks">500/' Default.qmc.in-wfnoj.xml
...
~/Documents/qmcpack/build/bin/qmcpack Li_wopos.qmc.in-wfnoj.xml &> polyquant_qmcpack.txt
