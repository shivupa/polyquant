...
TEST_SUITE("CALCULATION") {
  TEST_CASE("CALCULATION: H2O/sto-3g(library) SCF.") {
    ...
    CHECK(test_calc.scf_calc.D[0][1](0, 0) ==
          doctest::Approx(0.0239084665).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(
        test_calc.scf_calc.H_core[0](0, 0) ==
  ...
  TEST_CASE("CALCULATION: H2O/sto-3g quantum H SCF library basis.") {
    POLYQUANT_CALCULATION test_calc(
        "../../tests/data/h2o_sto3g_quantumHlibrary/h2o.json");
    test_calc.run();
    CHECK(test_calc.scf_calc.converged == true);
    CHECK(test_calc.scf_calc.independent_converged == true);
    CHECK(test_calc.scf_calc.exceeded_iterations == false);
    ...
    CHECK(
        test_calc.scf_calc.H_core[1](0, 0) ==
  ...
  TEST_CASE("CALCULATION: H2O/sto-3g quantum H SCF file basis.") {
    POLYQUANT_CALCULATION test_calc(
        "../../tests/data/h2o_sto3g_quantumHfile/h2o.json");
    test_calc.run();
    CHECK(test_calc.scf_calc.converged == true);
    CHECK(test_calc.scf_calc.independent_converged == true);
    CHECK(test_calc.scf_calc.exceeded_iterations == false);
  ...
  TEST_CASE("CALCULATION: Li-+p/custom basis quantum H SCF.") {
    ...
    CHECK(test_calc.scf_calc.exceeded_iterations == false);
    CHECK(test_calc.scf_calc.E_particles[0] ==
          doctest::Approx(-7.7455066481).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(test_calc.scf_calc.E_orbitals[0][0](0) ==
          doctest::Approx(-2.4172392427).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(std::abs(test_calc.scf_calc.C[0][0](0, 0)) ==
          doctest::Approx(0.1966873521).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(
        test_calc.scf_calc.F[0][0](0, 0) ==
        doctest::Approx(-26.7732049148).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(test_calc.scf_calc.D[0][0](0, 0) ==
    ...
    CHECK(test_calc.scf_calc.E_particles[1] ==
          doctest::Approx(0.21978317).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(test_calc.scf_calc.E_orbitals[1][0](0) ==
          doctest::Approx(-0.1098595111).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(std::abs(test_calc.scf_calc.C[1][0](0, 0)) ==
          doctest::Approx(0.0001239862).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(
        test_calc.scf_calc.F[1][0](0, 0) ==
        doctest::Approx(144.5305934829).epsilon(POLYQUANT_TEST_EPSILON_TIGHT));
    CHECK(test_calc.scf_calc.D[1][0](0, 0) ==
